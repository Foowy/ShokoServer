...
public class MySQL(SystemService systemService) : BaseDatabase<MySqlConnection>(systemService)
{
        ...
        ConnectionWrapper(GetConnectionString(), myConn =>
        {
            ...
            if (count == 0)
            {
                ...
                if (count > 0)
                {
                    ...
                    ExecuteWithException(myConn, _linuxTableVersionsFix);
                }
                else
                {
                    create = true;
            ...
            var update = ExecuteScalar(myConn, $"select count(*) from information_schema.columns where table_schema='{settings.Database.Schema}' and table_name = 'Versions' and column_name = 'VersionRevision'");
            if (count == 0)
            {
    ...
    private readonly List<DatabaseCommand> _createVersionTable =
    [
        new(  0,  1, "CREATE TABLE `Versions` ( `VersionsID` INT NOT NULL AUTO_INCREMENT , `VersionType` VARCHAR(100) NOT NULL , `VersionValue` VARCHAR(100) NOT NULL ,  PRIMARY KEY (`VersionsID`) ) ; "),
        new(  0,  2, "ALTER TABLE `Versions` ADD UNIQUE INDEX `UIX_Versions_VersionType` (`VersionType` ASC) ;")
    ];

    private readonly List<DatabaseCommand> _updateVersionTable =
    [
        new(  0,  3, "ALTER TABLE `Versions` ADD `VersionRevision` varchar(100) NULL;"),
        new(  0,  4, "ALTER TABLE `Versions` ADD `VersionCommand` text NULL;"),
        new(  0,  5, "ALTER TABLE `Versions` ADD `VersionProgram` varchar(100) NULL;"),
        new(  0,  6, "ALTER TABLE `Versions` DROP INDEX `UIX_Versions_VersionType` ;"),
        new(  0,  7, "ALTER TABLE `Versions` ADD INDEX `IX_Versions_VersionType` (`VersionType`,`VersionValue`,`VersionRevision`);")
    ];

    private readonly DatabaseCommand _linuxTableVersionsFix = new("RENAME TABLE versions TO Versions;");

    #endregion

    #region Tables | Create Commands

    private readonly List<DatabaseCommand> _createTables =
    [
        new(  1,   1),
        new(  1,   2),
        new(  1,   3, "CREATE TABLE `AniDB_Anime` ( `AniDB_AnimeID` INT NOT NULL AUTO_INCREMENT, `AnimeID` INT NOT NULL, `EpisodeCount` INT NOT NULL, `AirDate` varchar(10) NULL, `EndDate` varchar(10) NULL, `URL` text character set utf8 NULL, `Picname` text character set utf8 NULL, `BeginYear` INT NOT NULL, `EndYear` INT NOT NULL, `AnimeType` INT NOT NULL, `MainTitle` varchar(500) character set utf8 NOT NULL, `AllTitles` varchar(1500) character set utf8 NOT NULL, `AllCategories` text character set utf8 NOT NULL, `AllTags` text character set utf8 NOT NULL, `Description` text character set utf8 NOT NULL, `EpisodeCountNormal` INT NOT NULL, `EpisodeCountSpecial` INT NOT NULL, `Rating` INT NOT NULL, `VoteCount` INT NOT NULL, `TempRating` INT NOT NULL, `TempVoteCount` INT NOT NULL, `AvgReviewRating` INT NOT NULL, `ReviewCount` int NOT NULL, `DateTimeUpdated` datetime NOT NULL, `DateTimeDescUpdated` datetime NOT NULL, `ImageEnabled` int NOT NULL, `AwardList` text character set utf8 NOT NULL, `Restricted` int NOT NULL, `AnimePlanetID` int NULL, `ANNID` int NULL, `AllCinemaID` int NULL, `AnimeNfo` int NULL, `LatestEpisodeNumber` int NULL, PRIMARY KEY (`AniDB_AnimeID`) ) ; "),
        new(  1,   4, "ALTER TABLE `AniDB_Anime` ADD UNIQUE INDEX `UIX_AniDB_Anime_AnimeID` (`AnimeID` ASC) ;"),
        new(  1,   5, "CREATE TABLE `AniDB_Anime_Category` ( `AniDB_Anime_CategoryID` INT NOT NULL AUTO_INCREMENT, `AnimeID` int NOT NULL, `CategoryID` int NOT NULL, `Weighting` int NOT NULL, PRIMARY KEY (`AniDB_Anime_CategoryID`) ) ; "),
        new(  1,   6, "ALTER TABLE `AniDB_Anime_Category` ADD INDEX `IX_AniDB_Anime_Category_AnimeID` (`AnimeID` ASC) ;"),
        new(  1,   7, "ALTER TABLE `AniDB_Anime_Category` ADD UNIQUE INDEX `UIX_AniDB_Anime_Category_AnimeID_CategoryID` (`AnimeID` ASC, `CategoryID` ASC) ;"),
        new(  1,   8, "CREATE TABLE AniDB_Anime_Character ( `AniDB_Anime_CharacterID`  INT NOT NULL AUTO_INCREMENT, `AnimeID` int NOT NULL, `CharID` int NOT NULL, `CharType` varchar(100) NOT NULL, `EpisodeListRaw` text NULL, PRIMARY KEY (`AniDB_Anime_CharacterID`) ) ; "),
        new(  1,   9, "ALTER TABLE `AniDB_Anime_Character` ADD INDEX `IX_AniDB_Anime_Character_AnimeID` (`AnimeID` ASC) ;"),
        new(  1,  10, "ALTER TABLE `AniDB_Anime_Character` ADD UNIQUE INDEX `UIX_AniDB_Anime_Character_AnimeID_CharID` (`AnimeID` ASC, `CharID` ASC) ;"),
        new(  1,  11, "CREATE TABLE `AniDB_Anime_Relation` ( `AniDB_Anime_RelationID`  INT NOT NULL AUTO_INCREMENT, `AnimeID` int NOT NULL, `RelatedAnimeID` int NOT NULL, `RelationType` varchar(100) NOT NULL, PRIMARY KEY (`AniDB_Anime_RelationID`) ) ; "),
        new(  1,  12, "ALTER TABLE `AniDB_Anime_Relation` ADD INDEX `IX_AniDB_Anime_Relation_AnimeID` (`AnimeID` ASC) ;"),
        new(  1,  13, "ALTER TABLE `AniDB_Anime_Relation` ADD UNIQUE INDEX `UIX_AniDB_Anime_Relation_AnimeID_RelatedAnimeID` (`AnimeID` ASC, `RelatedAnimeID` ASC) ;"),
        new(  1,  14, "CREATE TABLE `AniDB_Anime_Review` ( `AniDB_Anime_ReviewID` INT NOT NULL AUTO_INCREMENT, `AnimeID` int NOT NULL, `ReviewID` int NOT NULL, PRIMARY KEY (`AniDB_Anime_ReviewID`) ) ; "),
        new(  1,  15, "ALTER TABLE `AniDB_Anime_Review` ADD INDEX `IX_AniDB_Anime_Review_AnimeID` (`AnimeID` ASC) ;"),
        new(  1,  16, "ALTER TABLE `AniDB_Anime_Review` ADD UNIQUE INDEX `UIX_AniDB_Anime_Review_AnimeID_ReviewID` (`AnimeID` ASC, `ReviewID` ASC) ;"),
        new(  1,  17, "CREATE TABLE `AniDB_Anime_Similar` ( `AniDB_Anime_SimilarID` INT NOT NULL AUTO_INCREMENT, `AnimeID` int NOT NULL, `SimilarAnimeID` int NOT NULL, `Approval` int NOT NULL, `Total` int NOT NULL, PRIMARY KEY (`AniDB_Anime_SimilarID`) ) ; "),
        new(  1,  18, "ALTER TABLE `AniDB_Anime_Similar` ADD INDEX `IX_AniDB_Anime_Similar_AnimeID` (`AnimeID` ASC) ;"),
        new(  1,  19, "ALTER TABLE `AniDB_Anime_Similar` ADD UNIQUE INDEX `UIX_AniDB_Anime_Similar_AnimeID_SimilarAnimeID` (`AnimeID` ASC, `SimilarAnimeID` ASC) ;"),
        new(  1,  20, "CREATE TABLE `AniDB_Anime_Tag` ( `AniDB_Anime_TagID` INT NOT NULL AUTO_INCREMENT, `AnimeID` int NOT NULL, `TagID` int NOT NULL, `Approval` int NOT NULL, PRIMARY KEY (`AniDB_Anime_TagID`) ) ; "),
        new(  1,  21, "ALTER TABLE `AniDB_Anime_Tag` ADD INDEX `IX_AniDB_Anime_Tag_AnimeID` (`AnimeID` ASC) ;"),
        new(  1,  22, "ALTER TABLE `AniDB_Anime_Tag` ADD UNIQUE INDEX `UIX_AniDB_Anime_Tag_AnimeID_TagID` (`AnimeID` ASC, `TagID` ASC) ;"),
        new(  1,  23, "CREATE TABLE `AniDB_Anime_Title` ( `AniDB_Anime_TitleID` INT NOT NULL AUTO_INCREMENT, `AnimeID` int NOT NULL, `TitleType` varchar(50) character set utf8 NOT NULL, `Language` varchar(50) character set utf8 NOT NULL, `Title` varchar(500) character set utf8 NOT NULL, PRIMARY KEY (`AniDB_Anime_TitleID`) ) ; "),
        new(  1,  24, "ALTER TABLE `AniDB_Anime_Title` ADD INDEX `IX_AniDB_Anime_Title_AnimeID` (`AnimeID` ASC) ;"),
        new(  1,  25, "CREATE TABLE `AniDB_Category` ( `AniDB_CategoryID` INT NOT NULL AUTO_INCREMENT, `CategoryID` int NOT NULL, `ParentID` int NOT NULL, `IsHentai` int NOT NULL, `CategoryName` varchar(50) NOT NULL, `CategoryDescription` text NOT NULL, PRIMARY KEY (`AniDB_CategoryID`) ) ; "),
        new(  1,  26, "ALTER TABLE `AniDB_Category` ADD UNIQUE INDEX `UIX_AniDB_Category_CategoryID` (`CategoryID` ASC) ;"),
        new(  1,  27, "CREATE TABLE `AniDB_Character` ( `AniDB_CharacterID` INT NOT NULL AUTO_INCREMENT, `CharID` int NOT NULL, `CharName` varchar(200) character set utf8 NOT NULL, `PicName` varchar(100) NOT NULL, `CharKanjiName` text character set utf8 NOT NULL, `CharDescription` text character set utf8 NOT NULL, `CreatorListRaw` text NOT NULL, PRIMARY KEY (`AniDB_CharacterID`) ) ; "),
        new(  1,  28, "ALTER TABLE `AniDB_Character` ADD UNIQUE INDEX `UIX_AniDB_Character_CharID` (`CharID` ASC) ;"),
        new(  1,  29, "CREATE TABLE `AniDB_Character_Seiyuu` ( `AniDB_Character_SeiyuuID` INT NOT NULL AUTO_INCREMENT, `CharID` int NOT NULL, `SeiyuuID` int NOT NULL, PRIMARY KEY (`AniDB_Character_SeiyuuID`) ) ; "),
        new(  1,  30, "ALTER TABLE `AniDB_Character_Seiyuu` ADD INDEX `IX_AniDB_Character_Seiyuu_CharID` (`CharID` ASC) ;"),
        new(  1,  31, "ALTER TABLE `AniDB_Character_Seiyuu` ADD INDEX `IX_AniDB_Character_Seiyuu_SeiyuuID` (`SeiyuuID` ASC) ;"),
        new(  1,  32, "ALTER TABLE `AniDB_Character_Seiyuu` ADD UNIQUE INDEX `UIX_AniDB_Character_Seiyuu_CharID_SeiyuuID` (`CharID` ASC, `SeiyuuID` ASC) ;"),
        new(  1,  33, "CREATE TABLE `AniDB_Seiyuu` ( `AniDB_SeiyuuID` INT NOT NULL AUTO_INCREMENT, `SeiyuuID` int NOT NULL, `SeiyuuName` varchar(200) character set utf8 NOT NULL, `PicName` varchar(100) NOT NULL, PRIMARY KEY (`AniDB_SeiyuuID`) ) ; "),
        new(  1,  34, "ALTER TABLE `AniDB_Seiyuu` ADD UNIQUE INDEX `UIX_AniDB_Seiyuu_SeiyuuID` (`SeiyuuID` ASC) ;"),
        new(  1,  35, "CREATE TABLE `AniDB_Episode` ( `AniDB_EpisodeID` INT NOT NULL AUTO_INCREMENT, `EpisodeID` int NOT NULL, `AnimeID` int NOT NULL, `LengthSeconds` int NOT NULL, `Rating` varchar(200) NOT NULL, `Votes` varchar(200) NOT NULL, `EpisodeNumber` int NOT NULL, `EpisodeType` int NOT NULL, `RomajiName` varchar(200) character set utf8 NOT NULL, `EnglishName` varchar(200) character set utf8 NOT NULL, `AirDate` int NOT NULL, `DateTimeUpdated` datetime NOT NULL, PRIMARY KEY (`AniDB_EpisodeID`) ) ; "),
        new(  1,  36, "ALTER TABLE `AniDB_Episode` ADD INDEX `IX_AniDB_Episode_AnimeID` (`AnimeID` ASC) ;"),
        new(  1,  37, "ALTER TABLE `AniDB_Episode` ADD UNIQUE INDEX `UIX_AniDB_Episode_EpisodeID` (`EpisodeID` ASC) ;"),
        new(  1,  38, "CREATE TABLE `AniDB_File`( `AniDB_FileID` INT NOT NULL AUTO_INCREMENT, `FileID` int NOT NULL, `Hash` varchar(50) NOT NULL, `AnimeID` int NOT NULL, `GroupID` int NOT NULL, `File_Source` varchar(200) NOT NULL, `File_AudioCodec` varchar(500) NOT NULL, `File_VideoCodec` varchar(200) NOT NULL, `File_VideoResolution` varchar(200) NOT NULL, `File_FileExtension` varchar(200) NOT NULL, `File_LengthSeconds` int NOT NULL, `File_Description` varchar(500) NOT NULL, `File_ReleaseDate` int NOT NULL, `Anime_GroupName` varchar(200) character set utf8 NOT NULL, `Anime_GroupNameShort` varchar(50) character set utf8 NOT NULL, `Episode_Rating` int NOT NULL, `Episode_Votes` int NOT NULL, `DateTimeUpdated` datetime NOT NULL, `IsWatched` int NOT NULL, `WatchedDate` datetime NULL, `CRC` varchar(200) NOT NULL, `MD5` varchar(200) NOT NULL, `SHA1` varchar(200) NOT NULL, `FileName` varchar(500) character set utf8 NOT NULL, `FileSize` bigint NOT NULL, PRIMARY KEY (`AniDB_FileID`) ) ; "),
        new(  1,  39, "ALTER TABLE `AniDB_File` ADD UNIQUE INDEX `UIX_AniDB_File_Hash` (`Hash` ASC) ;"),
        new(  1,  40, "ALTER TABLE `AniDB_File` ADD UNIQUE INDEX `UIX_AniDB_File_FileID` (`FileID` ASC) ;"),
        new(  1,  41, "CREATE TABLE `AniDB_GroupStatus` ( `AniDB_GroupStatusID` INT NOT NULL AUTO_INCREMENT, `AnimeID` int NOT NULL, `GroupID` int NOT NULL, `GroupName` varchar(200) character set utf8 NOT NULL, `CompletionState` int NOT NULL, `LastEpisodeNumber` int NOT NULL, `Rating` int NOT NULL, `Votes` int NOT NULL, `EpisodeRange` text NOT NULL, PRIMARY KEY (`AniDB_GroupStatusID`) ) ; "),
        new(  1,  42, "ALTER TABLE `AniDB_GroupStatus` ADD INDEX `IX_AniDB_GroupStatus_AnimeID` (`AnimeID` ASC) ;"),
        new(  1,  43, "ALTER TABLE `AniDB_GroupStatus` ADD UNIQUE INDEX `UIX_AniDB_GroupStatus_AnimeID_GroupID` (`AnimeID` ASC, `GroupID` ASC) ;"),
        new(  1,  44, "CREATE TABLE `AniDB_ReleaseGroup` ( `AniDB_ReleaseGroupID` INT NOT NULL AUTO_INCREMENT, `GroupID` int NOT NULL, `Rating` int NOT NULL, `Votes` int NOT NULL, `AnimeCount` int NOT NULL, `FileCount` int NOT NULL, `GroupName` varchar(200) character set utf8 NOT NULL, `GroupNameShort` varchar(50) character set utf8 NOT NULL, `IRCChannel` varchar(200) character set utf8 NOT NULL, `IRCServer` varchar(200) character set utf8 NOT NULL, `URL` varchar(200) character set utf8 NOT NULL, `Picname` varchar(50) NOT NULL, PRIMARY KEY (`AniDB_ReleaseGroupID`) ) ; "),
        new(  1,  45, "ALTER TABLE `AniDB_ReleaseGroup` ADD UNIQUE INDEX `UIX_AniDB_ReleaseGroup_GroupID` (`GroupID` ASC) ;"),
        new(  1,  46, "CREATE TABLE `AniDB_Review` ( `AniDB_ReviewID` INT NOT NULL AUTO_INCREMENT, `ReviewID` int NOT NULL, `AuthorID` int NOT NULL, `RatingAnimation` int NOT NULL, `RatingSound` int NOT NULL, `RatingStory` int NOT NULL, `RatingCharacter` int NOT NULL, `RatingValue` int NOT NULL, `RatingEnjoyment` int NOT NULL, `ReviewText` text character set utf8 NOT NULL, PRIMARY KEY (`AniDB_ReviewID`) ) ; "),
        new(  1,  47, "ALTER TABLE `AniDB_Review` ADD UNIQUE INDEX `UIX_AniDB_Review_ReviewID` (`ReviewID` ASC) ;"),
        new(  1,  48, "CREATE TABLE `AniDB_Tag` ( `AniDB_TagID` INT NOT NULL AUTO_INCREMENT, `TagID` int NOT NULL, `Spoiler` int NOT NULL, `LocalSpoiler` int NOT NULL, `GlobalSpoiler` int NOT NULL, `TagName` varchar(150) character set utf8 NOT NULL, `TagCount` int NOT NULL, `TagDescription` text character set utf8 NOT NULL, PRIMARY KEY (`AniDB_TagID`) ) ; "),
        new(  1,  49, "ALTER TABLE `AniDB_Tag` ADD UNIQUE INDEX `UIX_AniDB_Tag_TagID` (`TagID` ASC) ;"),
        new(  1,  50, "CREATE TABLE `AnimeEpisode` ( `AnimeEpisodeID` INT NOT NULL AUTO_INCREMENT, `AnimeSeriesID` int NOT NULL, `AniDB_EpisodeID` int NOT NULL, `DateTimeUpdated` datetime NOT NULL, `DateTimeCreated` datetime NOT NULL, PRIMARY KEY (`AnimeEpisodeID`) ) ; "),
        new(  1,  51, "ALTER TABLE `AnimeEpisode` ADD UNIQUE INDEX `UIX_AnimeEpisode_AniDB_EpisodeID` (`AniDB_EpisodeID` ASC) ;"),
        new(  1,  52, "ALTER TABLE `AnimeEpisode` ADD INDEX `IX_AnimeEpisode_AnimeSeriesID` (`AnimeSeriesID` ASC) ;"),
        new(  1,  53, "CREATE TABLE `AnimeEpisode_User` ( `AnimeEpisode_UserID` INT NOT NULL AUTO_INCREMENT, `JMMUserID` int NOT NULL, `AnimeEpisodeID` int NOT NULL, `AnimeSeriesID` int NOT NULL, `WatchedDate` datetime NULL, `PlayedCount` int NOT NULL, `WatchedCount` int NOT NULL, `StoppedCount` int NOT NULL, PRIMARY KEY (`AnimeEpisode_UserID`) ) ; "),
        ...
        new(  1,  55, "ALTER TABLE `AnimeEpisode_User` ADD INDEX `IX_AnimeEpisode_User_User_AnimeSeriesID` (`JMMUserID` ASC, `AnimeSeriesID` ASC) ;"),
        new(  1,  56, "CREATE TABLE `AnimeGroup` ( `AnimeGroupID` INT NOT NULL AUTO_INCREMENT, `AnimeGroupParentID` int NULL, `GroupName` varchar(200) character set utf8 NOT NULL, `Description` text character set utf8 NULL, `IsManuallyNamed` int NOT NULL, `DateTimeUpdated` datetime NOT NULL, `DateTimeCreated` datetime NOT NULL, `SortName` varchar(200) character set utf8 NOT NULL, `MissingEpisodeCount` int NOT NULL, `MissingEpisodeCountGroups` int NOT NULL, `OverrideDescription` int NOT NULL, `EpisodeAddedDate` datetime NULL, PRIMARY KEY (`AnimeGroupID`) ) ; "),
        new(  1,  57, "CREATE TABLE `AnimeSeries` ( `AnimeSeriesID` INT NOT NULL AUTO_INCREMENT, `AnimeGroupID` int NOT NULL, `AniDB_ID` int NOT NULL, `DateTimeUpdated` datetime NOT NULL, `DateTimeCreated` datetime NOT NULL, `DefaultAudioLanguage` varchar(50) NULL, `DefaultSubtitleLanguage` varchar(50) NULL, `MissingEpisodeCount` int NOT NULL, `MissingEpisodeCountGroups` int NOT NULL, `LatestLocalEpisodeNumber` int NOT NULL, `EpisodeAddedDate` datetime NULL, PRIMARY KEY (`AnimeSeriesID`) ) ; "),
        new(  1,  58, "ALTER TABLE `AnimeSeries` ADD UNIQUE INDEX `UIX_AnimeSeries_AniDB_ID` (`AniDB_ID` ASC) ;"),
        new(  1,  59, "CREATE TABLE `AnimeSeries_User` ( `AnimeSeries_UserID` INT NOT NULL AUTO_INCREMENT, `JMMUserID` int NOT NULL, `AnimeSeriesID` int NOT NULL, `UnwatchedEpisodeCount` int NOT NULL, `WatchedEpisodeCount` int NOT NULL, `WatchedDate` datetime NULL, `PlayedCount` int NOT NULL, `WatchedCount` int NOT NULL, `StoppedCount` int NOT NULL, PRIMARY KEY (`AnimeSeries_UserID`) ) ; "),
        new(  1,  60, "ALTER TABLE `AnimeSeries_User` ADD UNIQUE INDEX `UIX_AnimeSeries_User_User_SeriesID` (`JMMUserID` ASC, `AnimeSeriesID` ASC) ;"),
        new(  1,  61, "CREATE TABLE `AnimeGroup_User` ( `AnimeGroup_UserID` INT NOT NULL AUTO_INCREMENT, `JMMUserID` int NOT NULL, `AnimeGroupID` int NOT NULL, `IsFave` int NOT NULL, `UnwatchedEpisodeCount` int NOT NULL, `WatchedEpisodeCount` int NOT NULL, `WatchedDate` datetime NULL, `PlayedCount` int NOT NULL, `WatchedCount` int NOT NULL, `StoppedCount` int NOT NULL, PRIMARY KEY (`AnimeGroup_UserID`) ) ; "),
        new(  1,  62, "ALTER TABLE `AnimeGroup_User` ADD UNIQUE INDEX `UIX_AnimeGroup_User_User_GroupID` (`JMMUserID` ASC, `AnimeGroupID` ASC) ;"),
        new(  1,  63, "CREATE TABLE `VideoLocal` ( `VideoLocalID` INT NOT NULL AUTO_INCREMENT, `FilePath` text character set utf8 NOT NULL, `ImportFolderID` int NOT NULL, `Hash` varchar(50) NOT NULL, `CRC32` varchar(50) NULL, `MD5` varchar(50) NULL, `SHA1` varchar(50) NULL, `HashSource` int NOT NULL, `FileSize` bigint NOT NULL, `IsIgnored` int NOT NULL, `DateTimeUpdated` datetime NOT NULL, PRIMARY KEY (`VideoLocalID`) ) ; "),
        new(  1,  64, "ALTER TABLE `VideoLocal` ADD UNIQUE INDEX `UIX_VideoLocal_Hash` (`Hash` ASC) ;"),
        new(  1,  65, "CREATE TABLE VideoLocal_User( `VideoLocal_UserID` INT NOT NULL AUTO_INCREMENT, `JMMUserID` int NOT NULL, `VideoLocalID` int NOT NULL, `WatchedDate` datetime NOT NULL, PRIMARY KEY (`VideoLocal_UserID`) ) ; "),
        new(  1,  66, "ALTER TABLE `VideoLocal_User` ADD UNIQUE INDEX `UIX_VideoLocal_User_User_VideoLocalID` (`JMMUserID` ASC, `VideoLocalID` ASC) ;"),
        new(  1,  67, "CREATE TABLE `CommandRequest` ( `CommandRequestID` INT NOT NULL AUTO_INCREMENT, `Priority` int NOT NULL, `CommandType` int NOT NULL, `CommandID` varchar(250) NOT NULL, `CommandDetails` text character set utf8 NOT NULL, `DateTimeUpdated` datetime NOT NULL, PRIMARY KEY (`CommandRequestID`) ) ; "),
        new(  1,  68, "CREATE TABLE `CrossRef_AniDB_Other` ( `CrossRef_AniDB_OtherID` INT NOT NULL AUTO_INCREMENT, `AnimeID` int NOT NULL, `CrossRefID` varchar(100) character set utf8 NOT NULL, `CrossRefSource` int NOT NULL, `CrossRefType` int NOT NULL, PRIMARY KEY (`CrossRef_AniDB_OtherID`) ) ; "),
        new(  1,  69, "ALTER TABLE `CrossRef_AniDB_Other` ADD UNIQUE INDEX `UIX_CrossRef_AniDB_Other` (`AnimeID` ASC, `CrossRefID` ASC, `CrossRefSource` ASC, `CrossRefType` ASC) ;"),
        new(  1,  70, "CREATE TABLE `CrossRef_AniDB_TvDB` ( `CrossRef_AniDB_TvDBID` INT NOT NULL AUTO_INCREMENT, `AnimeID` int NOT NULL, `TvDBID` int NOT NULL, `TvDBSeasonNumber` int NOT NULL, `CrossRefSource` int NOT NULL, PRIMARY KEY (`CrossRef_AniDB_TvDBID`) ) ; "),
        new(  1,  71, "ALTER TABLE `CrossRef_AniDB_TvDB` ADD UNIQUE INDEX `UIX_CrossRef_AniDB_TvDB_AnimeID` (`AnimeID` ASC) ;"),
        new(  1,  72, "CREATE TABLE `CrossRef_File_Episode` ( `CrossRef_File_EpisodeID` INT NOT NULL AUTO_INCREMENT, `Hash` varchar(50) NULL, `FileName` varchar(500) character set utf8 NOT NULL, `FileSize` bigint NOT NULL, `CrossRefSource` int NOT NULL, `AnimeID` int NOT NULL, `EpisodeID` int NOT NULL, `Percentage` int NOT NULL, `EpisodeOrder` int NOT NULL, PRIMARY KEY (`CrossRef_File_EpisodeID`) ) ; "),
        new(  1,  73, "ALTER TABLE `CrossRef_File_Episode` ADD UNIQUE INDEX `UIX_CrossRef_File_Episode_Hash_EpisodeID` (`Hash` ASC, `EpisodeID` ASC) ;"),
        new(  1,  74, "CREATE TABLE `CrossRef_Languages_AniDB_File` ( `CrossRef_Languages_AniDB_FileID` INT NOT NULL AUTO_INCREMENT, `FileID` int NOT NULL, `LanguageID` int NOT NULL, PRIMARY KEY (`CrossRef_Languages_AniDB_FileID`) ) ; "),
        new(  1,  75, "CREATE TABLE `CrossRef_Subtitles_AniDB_File` ( `CrossRef_Subtitles_AniDB_FileID` INT NOT NULL AUTO_INCREMENT, `FileID` int NOT NULL, `LanguageID` int NOT NULL, PRIMARY KEY (`CrossRef_Subtitles_AniDB_FileID`) ) ; "),
        new(  1,  76, "CREATE TABLE `FileNameHash` ( `FileNameHashID` INT NOT NULL AUTO_INCREMENT, `FileName` varchar(500) character set utf8 NOT NULL, `FileSize` bigint NOT NULL, `Hash` varchar(50) NOT NULL, `DateTimeUpdated` datetime NOT NULL, PRIMARY KEY (`FileNameHashID`) ) ; "),
        new(  1,  77, "CREATE TABLE `Language` ( `LanguageID` INT NOT NULL AUTO_INCREMENT, `LanguageName` varchar(100) NOT NULL, PRIMARY KEY (`LanguageID`) ) ; "),
        new(  1,  78, "ALTER TABLE `Language` ADD UNIQUE INDEX `UIX_Language_LanguageName` (`LanguageName` ASC) ;"),
        new(  1,  79, "CREATE TABLE `ImportFolder` ( `ImportFolderID` INT NOT NULL AUTO_INCREMENT, `ImportFolderType` int NOT NULL, `ImportFolderName` varchar(500) character set utf8 NOT NULL, `ImportFolderLocation` varchar(500) character set utf8 NOT NULL, `IsDropSource` int NOT NULL, `IsDropDestination` int NOT NULL, PRIMARY KEY (`ImportFolderID`) ) ; "),
        new(  1,  80, "CREATE TABLE `ScheduledUpdate` ( `ScheduledUpdateID` INT NOT NULL AUTO_INCREMENT, `UpdateType` int NOT NULL, `LastUpdate` datetime NOT NULL, `UpdateDetails` text character set utf8 NOT NULL, PRIMARY KEY (`ScheduledUpdateID`) ) ; "),
        new(  1,  81, "ALTER TABLE `ScheduledUpdate` ADD UNIQUE INDEX `UIX_ScheduledUpdate_UpdateType` (`UpdateType` ASC) ;"),
        new(  1,  82, "CREATE TABLE `VideoInfo` ( `VideoInfoID` INT NOT NULL AUTO_INCREMENT, `Hash` varchar(50) NOT NULL, `FileSize` bigint NOT NULL, `FileName` text character set utf8 NOT NULL, `DateTimeUpdated` datetime NOT NULL, `VideoCodec` varchar(100) NOT NULL, `VideoBitrate` varchar(100) NOT NULL, `VideoFrameRate` varchar(100) NOT NULL, `VideoResolution` varchar(100) NOT NULL, `AudioCodec` varchar(100) NOT NULL, `AudioBitrate` varchar(100) NOT NULL, `Duration` bigint NOT NULL, PRIMARY KEY (`VideoInfoID`) ) ; "),
        new(  1,  83, "ALTER TABLE `VideoInfo` ADD UNIQUE INDEX `UIX_VideoInfo_Hash` (`Hash` ASC) ;"),
        new(  1,  84, "CREATE TABLE `DuplicateFile` ( `DuplicateFileID` INT NOT NULL AUTO_INCREMENT, `FilePathFile1` varchar(500) character set utf8 NOT NULL, `FilePathFile2` varchar(500) character set utf8 NOT NULL, `ImportFolderIDFile1` int NOT NULL, `ImportFolderIDFile2` int NOT NULL, `Hash` varchar(50) NOT NULL, `DateTimeUpdated` datetime NOT NULL, PRIMARY KEY (`DuplicateFileID`) ) ; "),
        new(  1,  85, "CREATE TABLE `GroupFilter` ( `GroupFilterID` INT NOT NULL AUTO_INCREMENT, `GroupFilterName` varchar(500) character set utf8 NOT NULL, `ApplyToSeries` int NOT NULL, `BaseCondition` int NOT NULL, `SortingCriteria` text character set utf8, PRIMARY KEY (`GroupFilterID`) ) ; "),
        new(  1,  86, "CREATE TABLE `GroupFilterCondition` ( `GroupFilterConditionID` INT NOT NULL AUTO_INCREMENT, `GroupFilterID` int NOT NULL, `ConditionType` int NOT NULL, `ConditionOperator` int NOT NULL, `ConditionParameter` text character set utf8 NOT NULL, PRIMARY KEY (`GroupFilterConditionID`) ) ; "),
        new(  1,  87, "CREATE TABLE `AniDB_Vote` ( `AniDB_VoteID` INT NOT NULL AUTO_INCREMENT, `EntityID` int NOT NULL, `VoteValue` int NOT NULL, `VoteType` int NOT NULL, PRIMARY KEY (`AniDB_VoteID`) ) ; "),
        new(  1,  88, "CREATE TABLE `TvDB_ImageFanart` ( `TvDB_ImageFanartID` INT NOT NULL AUTO_INCREMENT, `Id` int NOT NULL, `SeriesID` int NOT NULL, `BannerPath` varchar(200) character set utf8,  `BannerType` varchar(200) character set utf8,  `BannerType2` varchar(200) character set utf8,  `Colors` varchar(200) character set utf8,  `Language` varchar(200) character set utf8,  `ThumbnailPath` varchar(200) character set utf8,  `VignettePath` varchar(200) character set utf8,  `Enabled` int NOT NULL, `Chosen` int NOT NULL, PRIMARY KEY (`TvDB_ImageFanartID`) ) ; "),
        new(  1,  89, "ALTER TABLE `TvDB_ImageFanart` ADD UNIQUE INDEX `UIX_TvDB_ImageFanart_Id` (`Id` ASC) ;"),
        new(  1,  90, "CREATE TABLE `TvDB_ImageWideBanner` ( `TvDB_ImageWideBannerID` INT NOT NULL AUTO_INCREMENT, `Id` int NOT NULL, `SeriesID` int NOT NULL, `BannerPath` varchar(200) character set utf8,  `BannerType` varchar(200) character set utf8,  `BannerType2` varchar(200) character set utf8,  `Language`varchar(200) character set utf8,  `Enabled` int NOT NULL, `SeasonNumber` int, PRIMARY KEY (`TvDB_ImageWideBannerID`) ) ; "),
        new(  1,  91, "ALTER TABLE `TvDB_ImageWideBanner` ADD UNIQUE INDEX `UIX_TvDB_ImageWideBanner_Id` (`Id` ASC) ;"),
        new(  1,  92, "CREATE TABLE `TvDB_ImagePoster` ( `TvDB_ImagePosterID` INT NOT NULL AUTO_INCREMENT, `Id` int NOT NULL, `SeriesID` int NOT NULL, `BannerPath` varchar(200) character set utf8,  `BannerType` varchar(200) character set utf8,  `BannerType2` varchar(200) character set utf8,  `Language` varchar(200) character set utf8,  `Enabled` int NOT NULL, `SeasonNumber` int, PRIMARY KEY (`TvDB_ImagePosterID`) ) ; "),
        new(  1,  93, "ALTER TABLE `TvDB_ImagePoster` ADD UNIQUE INDEX `UIX_TvDB_ImagePoster_Id` (`Id` ASC) ;"),
        new(  1,  94, "CREATE TABLE `TvDB_Episode` ( `TvDB_EpisodeID` INT NOT NULL AUTO_INCREMENT, `Id` int NOT NULL, `SeriesID` int NOT NULL, `SeasonID` int NOT NULL, `SeasonNumber` int NOT NULL, `EpisodeNumber` int NOT NULL, `EpisodeName` varchar(200) character set utf8, `Overview` text character set utf8, `Filename` varchar(500) character set utf8, `EpImgFlag` int NOT NULL, `FirstAired` varchar(100) character set utf8, `AbsoluteNumber` int, `AirsAfterSeason` int, `AirsBeforeEpisode` int, `AirsBeforeSeason` int, PRIMARY KEY (`TvDB_EpisodeID`) ) ; "),
        new(  1,  95, "ALTER TABLE `TvDB_Episode` ADD UNIQUE INDEX `UIX_TvDB_Episode_Id` (`Id` ASC) ;"),
        new(  1,  96, "CREATE TABLE `TvDB_Series` ( `TvDB_SeriesID` INT NOT NULL AUTO_INCREMENT, `SeriesID` int NOT NULL, `Overview` text character set utf8, `SeriesName` varchar(250) character set utf8, `Status` varchar(100), `Banner` varchar(100), `Fanart` varchar(100), `Poster` varchar(100), `Lastupdated` varchar(100), PRIMARY KEY (`TvDB_SeriesID`) ) ; "),
        new(  1,  97, "ALTER TABLE `TvDB_Series` ADD UNIQUE INDEX `UIX_TvDB_Series_Id` (`SeriesID` ASC) ;"),
        new(  1,  98, "CREATE TABLE `AniDB_Anime_DefaultImage` ( `AniDB_Anime_DefaultImageID` INT NOT NULL AUTO_INCREMENT, `AnimeID` int NOT NULL, `ImageParentID` int NOT NULL, `ImageParentType` int NOT NULL, `ImageType` int NOT NULL, PRIMARY KEY (`AniDB_Anime_DefaultImageID`) ) ; "),
        new(  1,  99, "ALTER TABLE `AniDB_Anime_DefaultImage` ADD UNIQUE INDEX `UIX_AniDB_Anime_DefaultImage_ImageType` (`AnimeID` ASC, `ImageType` ASC) ;"),
        new(  1, 100, "CREATE TABLE `MovieDB_Movie` ( `MovieDB_MovieID` INT NOT NULL AUTO_INCREMENT, `MovieId` int NOT NULL, `MovieName` varchar(250) character set utf8, `OriginalName` varchar(250) character set utf8, `Overview` text character set utf8, PRIMARY KEY (`MovieDB_MovieID`) ) ; "),
        new(  1, 101, "ALTER TABLE `MovieDB_Movie` ADD UNIQUE INDEX `UIX_MovieDB_Movie_Id` (`MovieId` ASC) ;"),
        new(  1, 102, "CREATE TABLE `MovieDB_Poster` ( `MovieDB_PosterID` INT NOT NULL AUTO_INCREMENT, `ImageID` varchar(100), `MovieId` int NOT NULL, `ImageType` varchar(100), `ImageSize` varchar(100),  `URL` text character set utf8,  `ImageWidth` int NOT NULL,  `ImageHeight` int NOT NULL,  `Enabled` int NOT NULL, PRIMARY KEY (`MovieDB_PosterID`) ) ; "),
        new(  1, 103, "CREATE TABLE `MovieDB_Fanart` ( `MovieDB_FanartID` INT NOT NULL AUTO_INCREMENT, `ImageID` varchar(100), `MovieId` int NOT NULL, `ImageType` varchar(100), `ImageSize` varchar(100),  `URL` text character set utf8,  `ImageWidth` int NOT NULL,  `ImageHeight` int NOT NULL,  `Enabled` int NOT NULL, PRIMARY KEY (`MovieDB_FanartID`) ) ; "),
        new(  1, 104, "CREATE TABLE `JMMUser` ( `JMMUserID` INT NOT NULL AUTO_INCREMENT, `Username` varchar(100) character set utf8, `Password` varchar(100) character set utf8, `IsAdmin` int NOT NULL, `IsAniDBUser` int NOT NULL, `IsTraktUser` int NOT NULL, `HideCategories` text character set utf8, PRIMARY KEY (`JMMUserID`) ) ; "),
        new(  1, 105, "CREATE TABLE `Trakt_Episode` ( `Trakt_EpisodeID` INT NOT NULL AUTO_INCREMENT, `Trakt_ShowID` int NOT NULL, `Season` int NOT NULL, `EpisodeNumber` int NOT NULL, `Title` varchar(500) character set utf8, `URL` text character set utf8, `Overview` text character set utf8, `EpisodeImage` varchar(500) character set utf8, PRIMARY KEY (`Trakt_EpisodeID`) ) ; "),
        new(  1, 106, "CREATE TABLE `Trakt_ImagePoster` ( `Trakt_ImagePosterID` INT NOT NULL AUTO_INCREMENT, `Trakt_ShowID` int NOT NULL, `Season` int NOT NULL, `ImageURL` varchar(500) character set utf8, `Enabled` int NOT NULL, PRIMARY KEY (`Trakt_ImagePosterID`) ) ; "),
        new(  1, 107, "CREATE TABLE `Trakt_ImageFanart` ( `Trakt_ImageFanartID` INT NOT NULL AUTO_INCREMENT, `Trakt_ShowID` int NOT NULL, `Season` int NOT NULL, `ImageURL` varchar(500) character set utf8, `Enabled` int NOT NULL, PRIMARY KEY (`Trakt_ImageFanartID`) ) ; "),
        new(  1, 108, "CREATE TABLE `Trakt_Show` ( `Trakt_ShowID` INT NOT NULL AUTO_INCREMENT, `TraktID` varchar(100) character set utf8, `Title` varchar(500) character set utf8, `Year` varchar(50) character set utf8, `URL` text character set utf8, `Overview` text character set utf8, `TvDB_ID` int NULL, PRIMARY KEY (`Trakt_ShowID`) ) ; "),
        new(  1, 109, "CREATE TABLE `Trakt_Season` ( `Trakt_SeasonID` INT NOT NULL AUTO_INCREMENT, `Trakt_ShowID` int NOT NULL, `Season` int NOT NULL, `URL` text character set utf8, PRIMARY KEY (`Trakt_SeasonID`) ) ; "),
        new(  1, 110, "CREATE TABLE `CrossRef_AniDB_Trakt` ( `CrossRef_AniDB_TraktID` INT NOT NULL AUTO_INCREMENT, `AnimeID` int NOT NULL, `TraktID` varchar(100) character set utf8, `TraktSeasonNumber` int NOT NULL, `CrossRefSource` int NOT NULL, PRIMARY KEY (`CrossRef_AniDB_TraktID`) ) ; "),
    ];
    ...
    private readonly List<DatabaseCommand> _patchCommands =
    [
        new(  2,  1, "CREATE TABLE `IgnoreAnime` ( `IgnoreAnimeID` INT NOT NULL AUTO_INCREMENT ,  `JMMUserID` int NOT NULL,  `AnimeID` int NOT NULL,  `IgnoreType` int NOT NULL,  PRIMARY KEY (`IgnoreAnimeID`) ) ; "),
        ...
        new(  7,  1),
        new(  7,  2),
        new(  7,  3, "ALTER TABLE `CrossRef_AniDB_TvDB` ADD UNIQUE INDEX `UIX_CrossRef_AniDB_TvDB_Season` (`TvDBID` ASC, `TvDBSeasonNumber` ASC) ;"),
        new(  7,  4, "ALTER TABLE `CrossRef_AniDB_Trakt` ADD UNIQUE INDEX `UIX_CrossRef_AniDB_Trakt_Season` (`TraktID` ASC, `TraktSeasonNumber` ASC) ;"),
        new(  7,  5, "ALTER TABLE `CrossRef_AniDB_Trakt` ADD UNIQUE INDEX `UIX_CrossRef_AniDB_Trakt_Anime` (`AnimeID` ASC) ;"),
        new(  8,  1, "ALTER TABLE JMMUser CHANGE COLUMN Password Password VARCHAR(150) NULL DEFAULT NULL ;"),
        new(  9,  1, "ALTER TABLE `CommandRequest` CHANGE COLUMN `CommandID` `CommandID` text character set utf8 NOT NULL ;"),
        new(  9,  2, "ALTER TABLE `CrossRef_File_Episode` CHANGE COLUMN `FileName` `FileName` text character set utf8 NOT NULL ;"),
        new(  9,  3, "ALTER TABLE `FileNameHash` CHANGE COLUMN `FileName` `FileName` text character set utf8 NOT NULL ;"),
        new( 10,  1, "ALTER TABLE `AniDB_Category` CHANGE COLUMN `CategoryName` `CategoryName` text character set utf8 NOT NULL ;"),
        new( 10,  2, "ALTER TABLE `AniDB_Category` CHANGE COLUMN `CategoryDescription` `CategoryDescription` text character set utf8 NOT NULL ;"),
        new( 10,  3, "ALTER TABLE `AniDB_Episode` CHANGE COLUMN `RomajiName` `RomajiName` text character set utf8 NOT NULL ;"),
        new( 10,  4, "ALTER TABLE `AniDB_Episode` CHANGE COLUMN `EnglishName` `EnglishName` text character set utf8 NOT NULL ;"),
        new( 10,  5, "ALTER TABLE `AniDB_Anime_Relation` CHANGE COLUMN `RelationType` `RelationType` text character set utf8 NOT NULL ;"),
        new( 10,  6, "ALTER TABLE `AniDB_Character` CHANGE COLUMN `CharName` `CharName` text character set utf8 NOT NULL ;"),
        new( 10,  7, "ALTER TABLE `AniDB_Seiyuu` CHANGE COLUMN `SeiyuuName` `SeiyuuName` text character set utf8 NOT NULL ;"),
        new( 10,  8, "ALTER TABLE `AniDB_File` CHANGE COLUMN `File_Description` `File_Description` text character set utf8 NOT NULL ;"),
        new( 10,  9, "ALTER TABLE `AniDB_File` CHANGE COLUMN `Anime_GroupName` `Anime_GroupName` text character set utf8 NOT NULL ;"),
        new( 10, 10, "ALTER TABLE `AniDB_File` CHANGE COLUMN `Anime_GroupNameShort` `Anime_GroupNameShort` text character set utf8 NOT NULL ;"),
        new( 10, 11, "ALTER TABLE `AniDB_File` CHANGE COLUMN `FileName` `FileName` text character set utf8 NOT NULL ;"),
        new( 10, 12, "ALTER TABLE `AniDB_GroupStatus` CHANGE COLUMN `GroupName` `GroupName` text character set utf8 NOT NULL ;"),
        new( 10, 13, "ALTER TABLE `AniDB_ReleaseGroup` CHANGE COLUMN `GroupName` `GroupName` text character set utf8 NOT NULL ;"),
        new( 10, 14, "ALTER TABLE `AniDB_ReleaseGroup` CHANGE COLUMN `GroupNameShort` `GroupNameShort` text character set utf8 NOT NULL ;"),
        new( 10, 15, "ALTER TABLE `AniDB_ReleaseGroup` CHANGE COLUMN `URL` `URL` text character set utf8 NOT NULL ;"),
        new( 10, 16, "ALTER TABLE `AnimeGroup` CHANGE COLUMN `GroupName` `GroupName` text character set utf8 NOT NULL ;"),
        new( 10, 17, "ALTER TABLE `AnimeGroup` CHANGE COLUMN `SortName` `SortName` text character set utf8 NOT NULL ;"),
        new( 10, 18, "ALTER TABLE `CommandRequest` CHANGE COLUMN `CommandID` `CommandID` text character set utf8 NOT NULL ;"),
        new( 10, 19, "ALTER TABLE `CrossRef_File_Episode` CHANGE COLUMN `FileName` `FileName` text character set utf8 NOT NULL ;"),
        new( 10, 20, "ALTER TABLE `FileNameHash` CHANGE COLUMN `FileName` `FileName` text character set utf8 NOT NULL ;"),
        new( 10, 21, "ALTER TABLE `ImportFolder` CHANGE COLUMN `ImportFolderLocation` `ImportFolderLocation` text character set utf8 NOT NULL ;"),
        new( 10, 22, "ALTER TABLE `DuplicateFile` CHANGE COLUMN `FilePathFile1` `FilePathFile1` text character set utf8 NOT NULL ;"),
        new( 10, 23, "ALTER TABLE `DuplicateFile` CHANGE COLUMN `FilePathFile2` `FilePathFile2` text character set utf8 NOT NULL ;"),
        new( 10, 24, "ALTER TABLE `TvDB_Episode` CHANGE COLUMN `Filename` `Filename` text character set utf8 NOT NULL ;"),
        new( 10, 25, "ALTER TABLE `TvDB_Episode` CHANGE COLUMN `EpisodeName` `EpisodeName` text character set utf8 NOT NULL ;"),
        new( 10, 26, "ALTER TABLE `TvDB_Series` CHANGE COLUMN `SeriesName` `SeriesName` text character set utf8 NOT NULL ;"),
        new( 10, 27, "ALTER TABLE `DuplicateFile` CHANGE COLUMN `FilePathFile2` `FilePathFile2` text character set utf8 NOT NULL ;"),
        new( 10, 28, "ALTER TABLE `DuplicateFile` CHANGE COLUMN `FilePathFile2` `FilePathFile2` text character set utf8 NOT NULL ;"),
        new( 11,  1, "ALTER TABLE `ImportFolder` ADD `IsWatched` int NULL ;"),
        new( 11,  2, "UPDATE ImportFolder SET IsWatched = 1 ;"),
        new( 11,  3, "ALTER TABLE `ImportFolder` CHANGE COLUMN `IsWatched` `IsWatched` int NOT NULL ;"),
        new( 12,  1, "CREATE TABLE CrossRef_AniDB_MAL( CrossRef_AniDB_MALID INT NOT NULL AUTO_INCREMENT, AnimeID int NOT NULL, MALID int NOT NULL, MALTitle text, CrossRefSource int NOT NULL, PRIMARY KEY (`CrossRef_AniDB_MALID`) ) ; "),
        new( 12,  2, "ALTER TABLE `CrossRef_AniDB_MAL` ADD UNIQUE INDEX `UIX_CrossRef_AniDB_MAL_AnimeID` (`AnimeID` ASC) ;"),
        new( 12,  3, "ALTER TABLE `CrossRef_AniDB_MAL` ADD UNIQUE INDEX `UIX_CrossRef_AniDB_MAL_MALID` (`MALID` ASC) ;"),
        new( 13,  1, "drop table `CrossRef_AniDB_MAL`;"),
        new( 13,  2, "CREATE TABLE CrossRef_AniDB_MAL( CrossRef_AniDB_MALID INT NOT NULL AUTO_INCREMENT, AnimeID int NOT NULL, MALID int NOT NULL, MALTitle text, StartEpisodeType int NOT NULL, StartEpisodeNumber int NOT NULL, CrossRefSource int NOT NULL, PRIMARY KEY (`CrossRef_AniDB_MALID`) ) ; "),
        new( 13,  3, "ALTER TABLE `CrossRef_AniDB_MAL` ADD UNIQUE INDEX `UIX_CrossRef_AniDB_MAL_AnimeID` (`AnimeID` ASC) ;"),
        new( 13,  4, "ALTER TABLE `CrossRef_AniDB_MAL` ADD UNIQUE INDEX `UIX_CrossRef_AniDB_MAL_Anime` (`MALID` ASC, `AnimeID` ASC, `StartEpisodeType` ASC, `StartEpisodeNumber` ASC) ;"),
        new( 14,  1, "CREATE TABLE Playlist( PlaylistID INT NOT NULL AUTO_INCREMENT, PlaylistName text character set utf8, PlaylistItems text character set utf8, DefaultPlayOrder int NOT NULL, PlayWatched int NOT NULL, PlayUnwatched int NOT NULL, PRIMARY KEY (`PlaylistID`) ) ; "),
        new( 15,  1, "ALTER TABLE `AnimeSeries` ADD `SeriesNameOverride` text NULL ;"),
        new( 16,  1, "CREATE TABLE BookmarkedAnime( BookmarkedAnimeID INT NOT NULL AUTO_INCREMENT, AnimeID int NOT NULL, Priority int NOT NULL, Notes text character set utf8, Downloading int NOT NULL, PRIMARY KEY (`BookmarkedAnimeID`) ) ; "),
        new( 16,  2, "ALTER TABLE `BookmarkedAnime` ADD UNIQUE INDEX `UIX_BookmarkedAnime_AnimeID` (`AnimeID` ASC) ;"),
        ...
        new( 17,  3, "ALTER TABLE `VideoLocal` CHANGE COLUMN `DateTimeCreated` `DateTimeCreated` datetime NOT NULL ;"),
        new( 18,  1, "CREATE TABLE `CrossRef_AniDB_TvDB_Episode` ( `CrossRef_AniDB_TvDB_EpisodeID` INT NOT NULL AUTO_INCREMENT, `AnimeID` int NOT NULL, `AniDBEpisodeID` int NOT NULL, `TvDBEpisodeID` int NOT NULL, PRIMARY KEY (`CrossRef_AniDB_TvDB_EpisodeID`) ) ; "),
        new( 18,  2, "ALTER TABLE `CrossRef_AniDB_TvDB_Episode` ADD UNIQUE INDEX `UIX_CrossRef_AniDB_TvDB_Episode_AniDBEpisodeID` (`AniDBEpisodeID` ASC) ;"),
        new( 19,  1, "CREATE TABLE `AniDB_MylistStats` ( `AniDB_MylistStatsID` INT NOT NULL AUTO_INCREMENT, `Animes` int NOT NULL, `Episodes` int NOT NULL, `Files` int NOT NULL, `SizeOfFiles` bigint NOT NULL, `AddedAnimes` int NOT NULL, `AddedEpisodes` int NOT NULL, `AddedFiles` int NOT NULL, `AddedGroups` int NOT NULL, `LeechPct` int NOT NULL, `GloryPct` int NOT NULL, `ViewedPct` int NOT NULL, `MylistPct` int NOT NULL, `ViewedMylistPct` int NOT NULL, `EpisodesViewed` int NOT NULL, `Votes` int NOT NULL, `Reviews` int NOT NULL, `ViewiedLength` int NOT NULL, PRIMARY KEY (`AniDB_MylistStatsID`) ) ; "),
        new( 20,  1, "CREATE TABLE `FileFfdshowPreset` ( `FileFfdshowPresetID` INT NOT NULL AUTO_INCREMENT, `Hash` varchar(50) NOT NULL, `FileSize` bigint NOT NULL, `Preset` text character set utf8, PRIMARY KEY (`FileFfdshowPresetID`) ) ; "),
        new( 20,  2, "ALTER TABLE `FileFfdshowPreset` ADD UNIQUE INDEX `UIX_FileFfdshowPreset_Hash` (`Hash` ASC, `FileSize` ASC) ;"),
        ...
        new( 21,  3, "ALTER TABLE `AniDB_Anime` CHANGE COLUMN `DisableExternalLinksFlag` `DisableExternalLinksFlag` int NOT NULL ;"),
        new( 22,  1, "ALTER TABLE `AniDB_File` ADD `FileVersion` int NULL ;"),
        new( 22,  2, "UPDATE AniDB_File SET FileVersion = 1 ;"),
        new( 22,  3, "ALTER TABLE `AniDB_File` CHANGE COLUMN `FileVersion` `FileVersion` int NOT NULL ;"),
        new( 23,  1, "CREATE TABLE RenameScript( RenameScriptID INT NOT NULL AUTO_INCREMENT, ScriptName text character set utf8, Script text character set utf8, IsEnabledOnImport int NOT NULL, PRIMARY KEY (`RenameScriptID`) ) ; "),
        ...
        new( 24,  7, "ALTER TABLE `AniDB_File` CHANGE COLUMN `IsCensored` `IsCensored` int NOT NULL ;"),
        new( 24,  8, "ALTER TABLE `AniDB_File` CHANGE COLUMN `IsDeprecated` `IsDeprecated` int NOT NULL ;"),
        new( 24,  9, "ALTER TABLE `AniDB_File` CHANGE COLUMN `InternalVersion` `InternalVersion` int NOT NULL ;"),
        new( 25,  1, "ALTER TABLE `VideoLocal` ADD `IsVariation` int NULL ;"),
        new( 25,  2, "UPDATE VideoLocal SET IsVariation = 0 ;"),
        new( 25,  3, "ALTER TABLE `VideoLocal` CHANGE COLUMN `IsVariation` `IsVariation` int NOT NULL ;"),
        new( 26,  1, "CREATE TABLE AniDB_Recommendation( AniDB_RecommendationID INT NOT NULL AUTO_INCREMENT, AnimeID int NOT NULL, UserID int NOT NULL, RecommendationType int NOT NULL, RecommendationText text character set utf8, PRIMARY KEY (`AniDB_RecommendationID`) ) ; "),
        new( 26,  2, "ALTER TABLE `AniDB_Recommendation` ADD UNIQUE INDEX `UIX_AniDB_Recommendation` (`AnimeID` ASC, `UserID` ASC) ;"),
        ...
        new( 28,  1, "CREATE TABLE LogMessage( LogMessageID INT NOT NULL AUTO_INCREMENT, LogType text character set utf8, LogContent text character set utf8, LogDate datetime NOT NULL, PRIMARY KEY (`LogMessageID`) ) ; "),
        ...
        new( 29,  2, "ALTER TABLE `CrossRef_AniDB_TvDBV2` ADD UNIQUE INDEX `UIX_CrossRef_AniDB_TvDBV2` (`AnimeID` ASC, `TvDBID` ASC, `TvDBSeasonNumber` ASC, `TvDBStartEpisodeNumber` ASC, `AniDBStartEpisodeType` ASC, `AniDBStartEpisodeNumber` ASC) ;"),
        new( 29,  3),
        ...
        new( 32,  2, "ALTER TABLE `CrossRef_AniDB_TraktV2` ADD UNIQUE INDEX `UIX_CrossRef_AniDB_TraktV2` (`AnimeID` ASC, `TraktSeasonNumber` ASC, `TraktStartEpisodeNumber` ASC, `AniDBStartEpisodeType` ASC, `AniDBStartEpisodeNumber` ASC) ;"),
        new( 32,  3),
        new( 33,  1, "CREATE TABLE `CrossRef_AniDB_Trakt_Episode` ( `CrossRef_AniDB_Trakt_EpisodeID` INT NOT NULL AUTO_INCREMENT, `AnimeID` int NOT NULL, `AniDBEpisodeID` int NOT NULL, `TraktID` varchar(100) character set utf8, `Season` int NOT NULL, `EpisodeNumber` int NOT NULL, PRIMARY KEY (`CrossRef_AniDB_Trakt_EpisodeID`) ) ; "),
        new( 33,  2, "ALTER TABLE `CrossRef_AniDB_Trakt_Episode` ADD UNIQUE INDEX `UIX_CrossRef_AniDB_Trakt_Episode_AniDBEpisodeID` (`AniDBEpisodeID` ASC) ;"),
        new( 34,  1),
        ...
        new( 37,  4, "ALTER TABLE `CrossRef_AniDB_MAL` ADD UNIQUE INDEX `UIX_CrossRef_AniDB_MAL_Anime` (`AnimeID` ASC, `StartEpisodeType` ASC, `StartEpisodeNumber` ASC) ;"),
        ...
        new( 45,  3, "ALTER TABLE `GroupFilter` CHANGE COLUMN `FilterType` `FilterType` int NOT NULL ;"),
        new( 45,  4),
        new( 46,  1, "ALTER TABLE `AniDB_Anime` ADD `ContractVersion` int NOT NULL DEFAULT 0"),
        new( 46,  2, "ALTER TABLE `AniDB_Anime` ADD `ContractString` mediumtext character set utf8 NULL"),
        new( 46,  3, "ALTER TABLE `AnimeGroup` ADD `ContractVersion` int NOT NULL DEFAULT 0"),
        new( 46,  4, "ALTER TABLE `AnimeGroup` ADD `ContractString` mediumtext character set utf8 NULL"),
        new( 46,  5, "ALTER TABLE `AnimeGroup_User` ADD `PlexContractVersion` int NOT NULL DEFAULT 0"),
        new( 46,  6, "ALTER TABLE `AnimeGroup_User` ADD `PlexContractString` mediumtext character set utf8 NULL"),
        new( 46,  7, "ALTER TABLE `AnimeGroup_User` ADD `KodiContractVersion` int NOT NULL DEFAULT 0"),
        new( 46,  8, "ALTER TABLE `AnimeGroup_User` ADD `KodiContractString` mediumtext character set utf8 NULL"),
        new( 46,  9, "ALTER TABLE `AnimeSeries` ADD `ContractVersion` int NOT NULL DEFAULT 0"),
        new( 46, 10, "ALTER TABLE `AnimeSeries` ADD `ContractString` mediumtext character set utf8 NULL"),
        new( 46, 11, "ALTER TABLE `AnimeSeries_User` ADD `PlexContractVersion` int NOT NULL DEFAULT 0"),
        new( 46, 12, "ALTER TABLE `AnimeSeries_User` ADD `PlexContractString` mediumtext character set utf8 NULL"),
        new( 46, 13, "ALTER TABLE `AnimeSeries_User` ADD `KodiContractVersion` int NOT NULL DEFAULT 0"),
        new( 46, 14, "ALTER TABLE `AnimeSeries_User` ADD `KodiContractString` mediumtext character set utf8 NULL"),
        new( 46, 15, "ALTER TABLE `GroupFilter` ADD `GroupsIdsVersion` int NOT NULL DEFAULT 0"),
        new( 46, 16, "ALTER TABLE `GroupFilter` ADD `GroupsIdsString` mediumtext character set utf8 NULL"),
        new( 46, 17, "ALTER TABLE `AnimeEpisode_User` ADD `ContractVersion` int NOT NULL DEFAULT 0"),
        new( 46, 18, "ALTER TABLE `AnimeEpisode_User` ADD `ContractString` mediumtext character set utf8 NULL"),
        new( 47,  1, "ALTER TABLE `AnimeEpisode` ADD `PlexContractVersion` int NOT NULL DEFAULT 0"),
        new( 47,  2, "ALTER TABLE `AnimeEpisode` ADD `PlexContractString` mediumtext character set utf8 NULL"),
        ...
        new( 50,  2, "ALTER TABLE `GroupFilter` ADD `GroupConditions` mediumtext character set utf8 NULL"),
        ...
        new( 50,  6, "ALTER TABLE `GroupFilter` ADD `SeriesIdsString` mediumtext character set utf8 NULL"),
        ...
        new( 54,  1, "CREATE TABLE `VideoLocal_Place` ( `VideoLocal_Place_ID` INT NOT NULL AUTO_INCREMENT, `VideoLocalID` int NOT NULL, `FilePath` text character set utf8 NOT NULL, `ImportFolderID` int NOT NULL, `ImportFolderType` int NOT NULL, PRIMARY KEY (`VideoLocal_Place_ID`) ) ; "),
        ...
        new( 54,  6, "ALTER TABLE `VideoLocal` ADD `VideoFrameRate` varchar(100) NOT NULL DEFAULT ''"),
        new( 54,  7, "ALTER TABLE `VideoLocal` ADD `VideoResolution` varchar(100) NOT NULL DEFAULT ''"),
        ...
        new( 54, 11, "INSERT INTO `VideoLocal_Place` (`VideoLocalID`, `FilePath`, `ImportFolderID`, `ImportFolderType`) SELECT `VideoLocalID`, `FilePath`, `ImportFolderID`, 1 as `ImportFolderType` FROM `VideoLocal`"),
        new( 54, 12, "ALTER TABLE `VideoLocal` DROP COLUMN `FilePath`"),
        new( 54, 13, "ALTER TABLE `VideoLocal` DROP COLUMN `ImportFolderID`"),
        new( 54, 14, "CREATE TABLE `CloudAccount` ( `CloudID` INT NOT NULL AUTO_INCREMENT,  `ConnectionString` text character set utf8 NOT NULL,  `Provider` varchar(100) NOT NULL DEFAULT '', `Name` varchar(256) NOT NULL DEFAULT '',  PRIMARY KEY (`CloudID`) ) ; "),
        ...
        new( 56,  1, "CREATE TABLE `AuthTokens` ( `AuthID` INT NOT NULL AUTO_INCREMENT, `UserID` int NOT NULL, `DeviceName` text character set utf8, `Token` text character set utf8, PRIMARY KEY (`AuthID`) ) ; "),
        new( 57,  1, "CREATE TABLE `Scan` ( `ScanID` INT NOT NULL AUTO_INCREMENT, `CreationTime` datetime NOT NULL, `ImportFolders` text character set utf8, `Status` int NOT NULL, PRIMARY KEY (`ScanID`) ) ; "),
        new( 57,  2, "CREATE TABLE `ScanFile` ( `ScanFileID` INT NOT NULL AUTO_INCREMENT, `ScanID` int NOT NULL, `ImportFolderID` int NOT NULL, `VideoLocal_Place_ID` int NOT NULL, `FullName` text character set utf8, `FileSize` bigint NOT NULL, `Status` int NOT NULL, `CheckDate` datetime NULL, `Hash` text character set utf8, `HashResult` text character set utf8 NULL, PRIMARY KEY (`ScanFileID`) ) ; "),
        new( 57,  3, "ALTER TABLE `ScanFile` ADD  INDEX `UIX_ScanFileStatus` (`ScanID` ASC, `Status` ASC, `CheckDate` ASC) ;"),
        new( 58,  1),
        new( 59,  1, "ALTER TABLE `GroupFilter` ADD INDEX `IX_groupfilter_GroupFilterName` (`GroupFilterName`(250));"),
        new( 60,  1),
        new( 61,  1),
        ...
        new( 65,  1, "ALTER TABLE RenameScript ADD RenamerType varchar(255) character set utf8 NOT NULL DEFAULT 'Legacy'"),
        new( 65,  2, "ALTER TABLE RenameScript ADD ExtraData TEXT character set utf8"),
        new( 66,  1, "ALTER TABLE `AniDB_Anime_Character` ADD INDEX `IX_AniDB_Anime_Character_CharID` (`CharID` ASC) ;"),
        ...
        new( 70,  1, "CREATE TABLE `AnimeCharacter` ( `CharacterID` INT NOT NULL AUTO_INCREMENT, `AniDBID` INT NOT NULL, `Name` text character set utf8 NOT NULL, `AlternateName` text character set utf8 NULL, `Description` text character set utf8 NULL, `ImagePath` text character set utf8 NULL, PRIMARY KEY (`CharacterID`) )"),
        new( 70,  2, "CREATE TABLE `AnimeStaff` ( `StaffID` INT NOT NULL AUTO_INCREMENT, `AniDBID` INT NOT NULL, `Name` text character set utf8 NOT NULL, `AlternateName` text character set utf8 NULL, `Description` text character set utf8 NULL, `ImagePath` text character set utf8 NULL, PRIMARY KEY (`StaffID`) )"),
        new( 70,  3, "CREATE TABLE `CrossRef_Anime_Staff` ( `CrossRef_Anime_StaffID` INT NOT NULL AUTO_INCREMENT, `AniDB_AnimeID` INT NOT NULL, `StaffID` INT NOT NULL, `Role` text character set utf8 NULL, `RoleID` INT, `RoleType` INT NOT NULL, `Language` text character set utf8 NOT NULL, PRIMARY KEY (`CrossRef_Anime_StaffID`) )"),
        new( 70,  4),
        ...
        new( 75,  1),
        new( 76,  1, "CREATE TABLE `AniDB_AnimeUpdate` ( `AniDB_AnimeUpdateID` INT NOT NULL AUTO_INCREMENT, `AnimeID` INT NOT NULL, `UpdatedAt` datetime NOT NULL, PRIMARY KEY (`AniDB_AnimeUpdateID`) );"),
        ...
        new( 80,  2, "ALTER TABLE `AniDB_Anime` ADD ( `Site_JP` text character set utf8 null, `Site_EN` text character set utf8 null, `Wikipedia_ID` text character set utf8 null, `WikipediaJP_ID` text character set utf8 null, `SyoboiID` INT NULL, `AnisonID` INT NULL, `CrunchyrollID` text character set utf8 null );"),
        new( 80,  3),
        ...
        new( 83,  3, "CREATE TABLE `AniDB_Episode_Title` ( `AniDB_Episode_TitleID` INT NOT NULL AUTO_INCREMENT, `AniDB_EpisodeID` int NOT NULL, `Language` varchar(50) character set utf8 NOT NULL, `Title` varchar(500) character set utf8 NOT NULL, PRIMARY KEY (`AniDB_Episode_TitleID`) ) ; "),
        new( 83,  4),
        new( 84,  1, "ALTER TABLE `CrossRef_AniDB_TvDB_Episode` DROP INDEX `UIX_CrossRef_AniDB_TvDB_Episode_AniDBEpisodeID`;"),
        ...
        new( 84,  4, "ALTER TABLE `CrossRef_AniDB_TvDB_Episode_Override` CHANGE `CrossRef_AniDB_TvDB_EpisodeID` `CrossRef_AniDB_TvDB_Episode_OverrideID` INT NOT NULL AUTO_INCREMENT;"),
        new( 84,  5, "ALTER TABLE `CrossRef_AniDB_TvDB_Episode_Override` ADD UNIQUE INDEX `UIX_AniDB_TvDB_Episode_Override_AniDBEpisodeID_TvDBEpisodeID` (`AniDBEpisodeID` ASC, `TvDBEpisodeID` ASC);"),
        new( 84,  6, "DROP TABLE `CrossRef_AniDB_TvDB`;"),
        new( 84,  7, "CREATE TABLE `CrossRef_AniDB_TvDB` ( `CrossRef_AniDB_TvDBID` INT NOT NULL AUTO_INCREMENT, `AniDBID` int NOT NULL, `TvDBID` int NOT NULL, `CrossRefSource` INT NOT NULL, PRIMARY KEY (`CrossRef_AniDB_TvDBID`));"),
        new( 84,  8, "ALTER TABLE `CrossRef_AniDB_TvDB` ADD UNIQUE INDEX `UIX_AniDB_TvDB_AniDBID_TvDBID` (`AniDBID` ASC, `TvDBID` ASC);"),
        new( 84,  9, "CREATE TABLE `CrossRef_AniDB_TvDB_Episode` ( `CrossRef_AniDB_TvDB_EpisodeID` INT NOT NULL AUTO_INCREMENT, `AniDBEpisodeID` int NOT NULL, `TvDBEpisodeID` int NOT NULL, `MatchRating` INT NOT NULL, PRIMARY KEY (`CrossRef_AniDB_TvDB_EpisodeID`) );"),
        new( 84, 10, "ALTER TABLE `CrossRef_AniDB_TvDB_Episode` ADD UNIQUE INDEX `UIX_CrossRef_AniDB_TvDB_Episode_AniDBID_TvDBID` ( `AniDBEpisodeID` ASC, `TvDBEpisodeID` ASC);"),
        new( 84, 11),
        new( 85,  1),
        new( 86,  1),
        ...
        new( 89,  1),
        new( 90,  1, "ALTER TABLE VideoLocal DROP COLUMN VideoCodec, DROP COLUMN VideoBitrate, DROP COLUMN VideoFrameRate, DROP COLUMN VideoResolution, DROP COLUMN AudioCodec, DROP COLUMN AudioBitrate, DROP COLUMN Duration;"),
        ...
        new( 95,  4, "UPDATE VideoLocal_User SET WatchedCount = 1, LastUpdated = WatchedDate WHERE WatchedDate IS NOT NULL;"),
        ...
        new( 98,  1, "ALTER TABLE AnimeEpisode_User DROP COLUMN ContractSize, DROP COLUMN ContractBlob, DROP COLUMN ContractVersion;"),
        new( 99,  1, "ALTER TABLE `AniDB_File` DROP `File_AudioCodec`, DROP `File_VideoCodec`, DROP `File_VideoResolution`, DROP `File_FileExtension`, DROP `File_LengthSeconds`, DROP `Anime_GroupName`, DROP `Anime_GroupNameShort`, DROP `Episode_Rating`, DROP `Episode_Votes`, DROP `IsWatched`, DROP `WatchedDate`, DROP `CRC`, DROP `MD5`, DROP `SHA1`"),
        ...
        new(100,  2, "UPDATE CrossRef_Languages_AniDB_File c INNER JOIN Language l ON l.LanguageID = c.LanguageID SET c.LanguageName = l.LanguageName WHERE c.LanguageName = '';"),
        ...
        new(100,  5, "UPDATE CrossRef_Subtitles_AniDB_File c INNER JOIN Language l ON l.LanguageID = c.LanguageID SET c.LanguageName = l.LanguageName WHERE c.LanguageName = '';"),
        ...
        new(101, 12, "ALTER TABLE CrossRef_File_Episode DROP INDEX IX_Xref_Epid; ALTER TABLE CrossRef_File_Episode ADD INDEX IX_CrossRef_File_Episode_EpisodeID (EpisodeID);"),
        ...
        new(101, 16, "ALTER TABLE VideoLocal DROP INDEX IX_VideoLocal_Hash; ALTER TABLE VideoLocal ADD UNIQUE INDEX UIX_VideoLocal_Hash (Hash);"),
        ...
        new(146,  1, "CREATE INDEX IX_CrossRef_AniDB_TMDB_Episode_AnidbAnimeID ON CrossRef_AniDB_TMDB_Episode(AnidbAnimeID);"),
        new(146,  2, "CREATE INDEX IX_CrossRef_AniDB_TMDB_Episode_AnidbAnimeID_TmdbShowID ON CrossRef_AniDB_TMDB_Episode(AnidbAnimeID, TmdbShowID);"),
        new(146,  3, "CREATE INDEX IX_CrossRef_AniDB_TMDB_Episode_AnidbEpisodeID ON CrossRef_AniDB_TMDB_Episode(AnidbEpisodeID);"),
        new(146,  4, "CREATE INDEX IX_CrossRef_AniDB_TMDB_Episode_AnidbEpisodeID_TmdbEpisodeID ON CrossRef_AniDB_TMDB_Episode(AnidbEpisodeID, TmdbEpisodeID);"),
        new(146,  5, "CREATE INDEX IX_CrossRef_AniDB_TMDB_Episode_TmdbEpisodeID ON CrossRef_AniDB_TMDB_Episode(TmdbEpisodeID);"),
        new(146,  6, "CREATE INDEX IX_CrossRef_AniDB_TMDB_Episode_TmdbShowID ON CrossRef_AniDB_TMDB_Episode(TmdbShowID);"),
        new(146,  7, "CREATE INDEX IX_CrossRef_AniDB_TMDB_Movie_AnidbAnimeID ON CrossRef_AniDB_TMDB_Movie(AnidbAnimeID);"),
        new(146,  8, "CREATE INDEX IX_CrossRef_AniDB_TMDB_Movie_AnidbEpisodeID ON CrossRef_AniDB_TMDB_Movie(AnidbEpisodeID);"),
        new(146,  9, "CREATE INDEX IX_CrossRef_AniDB_TMDB_Movie_AnidbEpisodeID_TmdbMovieID ON CrossRef_AniDB_TMDB_Movie(AnidbEpisodeID, TmdbMovieID);"),
        new(146, 10, "CREATE INDEX IX_CrossRef_AniDB_TMDB_Movie_TmdbMovieID ON CrossRef_AniDB_TMDB_Movie(TmdbMovieID);"),
        new(146, 11, "CREATE INDEX IX_CrossRef_AniDB_TMDB_Show_AnidbAnimeID ON CrossRef_AniDB_TMDB_Show(AnidbAnimeID);"),
        new(146, 12, "CREATE INDEX IX_CrossRef_AniDB_TMDB_Show_AnidbAnimeID_TmdbShowID ON CrossRef_AniDB_TMDB_Show(AnidbAnimeID, TmdbShowID);"),
        new(146, 13, "CREATE INDEX IX_CrossRef_AniDB_TMDB_Show_TmdbShowID ON CrossRef_AniDB_TMDB_Show(TmdbShowID);"),
        new(146, 14, "CREATE UNIQUE INDEX UIX_TMDB_AlternateOrdering_Season_TmdbEpisodeGroupID ON TMDB_AlternateOrdering_Season(TmdbEpisodeGroupID);"),
        new(146, 15, "CREATE INDEX IX_TMDB_AlternateOrdering_Season_TmdbEpisodeGroupCollectionID ON TMDB_AlternateOrdering_Season(TmdbEpisodeGroupCollectionID);"),
        new(146, 16, "CREATE INDEX IX_TMDB_AlternateOrdering_Season_TmdbShowID ON TMDB_AlternateOrdering_Season(TmdbShowID);"),
        new(146, 17, "CREATE UNIQUE INDEX UIX_TMDB_AlternateOrdering_TmdbEpisodeGroupCollectionID ON TMDB_AlternateOrdering(TmdbEpisodeGroupCollectionID);"),
        // Index name max length is 64.
        new(146, 18, "CREATE INDEX IX_TMDB_AlternateOrdering_TmdbEpisodeGroupCollection_TmdbShow ON TMDB_AlternateOrdering(TmdbEpisodeGroupCollectionID, TmdbShowID);"),
        new(146, 19, "CREATE INDEX IX_TMDB_AlternateOrdering_TmdbShowID ON TMDB_AlternateOrdering(TmdbShowID);"),
        new(146, 20, "CREATE UNIQUE INDEX UIX_TMDB_Collection_TmdbCollectionID ON TMDB_Collection(TmdbCollectionID);"),
        new(146, 21, "CREATE INDEX IX_TMDB_Collection_Movie_TmdbCollectionID ON TMDB_Collection_Movie(TmdbCollectionID);"),
        new(146, 22, "CREATE INDEX IX_TMDB_Collection_Movie_TmdbMovieID ON TMDB_Collection_Movie(TmdbMovieID);"),
        new(146, 23, "CREATE INDEX IX_TMDB_Company_Entity_TmdbCompanyID ON TMDB_Company_Entity(TmdbCompanyID);"),
        new(146, 24, "CREATE INDEX IX_TMDB_Company_Entity_TmdbEntityType_TmdbEntityID ON TMDB_Company_Entity(TmdbEntityType, TmdbEntityID);"),
        new(146, 25, "CREATE INDEX IX_TMDB_Company_TmdbCompanyID ON TMDB_Company(TmdbCompanyID);"),
        new(146, 26, "CREATE INDEX IX_TMDB_Episode_Cast_TmdbEpisodeID ON TMDB_Episode_Cast(TmdbEpisodeID);"),
        new(146, 27, "CREATE INDEX IX_TMDB_Episode_Cast_TmdbPersonID ON TMDB_Episode_Cast(TmdbPersonID);"),
        new(146, 28, "CREATE INDEX IX_TMDB_Episode_Cast_TmdbSeasonID ON TMDB_Episode_Cast(TmdbSeasonID);"),
        new(146, 29, "CREATE INDEX IX_TMDB_Episode_Cast_TmdbShowID ON TMDB_Episode_Cast(TmdbShowID);"),
        new(146, 30, "CREATE INDEX IX_TMDB_Episode_Crew_TmdbEpisodeID ON TMDB_Episode_Crew(TmdbEpisodeID);"),
        new(146, 31, "CREATE INDEX IX_TMDB_Episode_Crew_TmdbPersonID ON TMDB_Episode_Crew(TmdbPersonID);"),
        new(146, 32, "CREATE INDEX IX_TMDB_Episode_Crew_TmdbSeasonID ON TMDB_Episode_Crew(TmdbSeasonID);"),
        new(146, 33, "CREATE INDEX IX_TMDB_Episode_Crew_TmdbShowID ON TMDB_Episode_Crew(TmdbShowID);"),
        new(146, 34, "CREATE INDEX IX_TMDB_Movie_Cast_TmdbMovieID ON TMDB_Movie_Cast(TmdbMovieID);"),
        new(146, 35, "CREATE INDEX IX_TMDB_Movie_Cast_TmdbPersonID ON TMDB_Movie_Cast(TmdbPersonID);"),
        new(146, 36, "CREATE INDEX IX_TMDB_Movie_Crew_TmdbMovieID ON TMDB_Movie_Crew(TmdbMovieID);"),
        new(146, 37, "CREATE INDEX IX_TMDB_Movie_Crew_TmdbPersonID ON TMDB_Movie_Crew(TmdbPersonID);"),
        new(146, 38, "CREATE UNIQUE INDEX UIX_TMDB_Movie_TmdbMovieID ON TMDB_Movie(TmdbMovieID);"),
        new(146, 39, "CREATE INDEX IX_TMDB_Movie_TmdbCollectionID ON TMDB_Movie(TmdbCollectionID);"),
        new(146, 40, "CREATE INDEX IX_TMDB_Person_TmdbPersonID ON TMDB_Person(TmdbPersonID);"),
        ...
        new(147,  1, "DROP TABLE IF EXISTS AnimeStaff;"),
        new(147,  2, "DROP TABLE IF EXISTS CrossRef_Anime_Staff;"),
        new(147,  3, "DROP TABLE IF EXISTS AniDB_Character;"),
        new(147,  4, "DROP TABLE IF EXISTS AniDB_Anime_Staff;"),
        new(147,  5, "DROP TABLE IF EXISTS AniDB_Anime_Character;"),
        new(147,  6, "DROP TABLE IF EXISTS AniDB_Character_Creator;"),
        // One character's name is 502 characters long, so 512 it is. Blame Gintama.
        new(147,  7, "CREATE TABLE `AniDB_Character` (`AniDB_CharacterID` INT NOT NULL AUTO_INCREMENT, `CharacterID` INT NOT NULL, `Name` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `OriginalName` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `Description` TEXT CHARACTER SET UTF8 NOT NULL, `ImagePath` VARCHAR(20) CHARACTER SET UTF8 NOT NULL, Gender INT NOT NULL, PRIMARY KEY (`AniDB_CharacterID`));"),
        new(147,  8, "CREATE TABLE `AniDB_Anime_Staff` (`AniDB_Anime_StaffID` INT NOT NULL AUTO_INCREMENT, `AnimeID` INT NOT NULL, `CreatorID` INT NOT NULL, `Role` VARCHAR(64) CHARACTER SET UTF8 NOT NULL, `RoleType` INT NOT NULL, `Ordering` INT NOT NULL, PRIMARY KEY (`AniDB_Anime_StaffID`));"),
        new(147,  9, "CREATE TABLE `AniDB_Anime_Character` (`AniDB_Anime_CharacterID` INT NOT NULL AUTO_INCREMENT, `AnimeID` INT NOT NULL, `CharacterID` INT NOT NULL, `Appearance` VARCHAR(20) CHARACTER SET UTF8 NOT NULL, `AppearanceType` INT NOT NULL, `Ordering` INT NOT NULL, PRIMARY KEY (`AniDB_Anime_CharacterID`));"),
        ...
        new(147, 12),
        new(148,  1, "ALTER TABLE `AniDB_Character` ADD `Type` int NOT NULL DEFAULT 0;"),
        new(148,  2, "ALTER TABLE `AniDB_Character` ADD `LastUpdated` datetime NOT NULL DEFAULT '1970-01-01 00:00:00';"),
        new(148,  3, DatabaseFixes.RecreateAnimeCharactersAndCreators),
        new(149, 1, MySQLFixUTF8MB4),
        new(149, 2, SetDefaultCollationToUTF8MB4),
        new(150,  1, "CREATE TABLE `TMDB_Image_Entity` (`TMDB_Image_EntityID` INT NOT NULL AUTO_INCREMENT, `TmdbEntityID` INT NULL, `TmdbEntityType` INT NOT NULL, `ImageType` INT NOT NULL, `RemoteFileName` VARCHAR(128) NOT NULL, `Ordering` INT NOT NULL, `ReleasedAt` DATE NULL, PRIMARY KEY (`TMDB_Image_EntityID`));"),
        new(150,  2, "ALTER TABLE `TMDB_Image` DROP COLUMN `TmdbMovieID`;"),
        new(150,  3, "ALTER TABLE `TMDB_Image` DROP COLUMN `TmdbEpisodeID`;"),
        new(150,  4, "ALTER TABLE `TMDB_Image` DROP COLUMN `TmdbSeasonID`;"),
        new(150,  5, "ALTER TABLE `TMDB_Image` DROP COLUMN `TmdbShowID`;"),
        new(150,  6, "ALTER TABLE `TMDB_Image` DROP COLUMN `TmdbCollectionID`;"),
        new(150,  7, "ALTER TABLE `TMDB_Image` DROP COLUMN `TmdbNetworkID`;"),
        new(150,  8, "ALTER TABLE `TMDB_Image` DROP COLUMN `TmdbCompanyID`;"),
        new(150,  9, "ALTER TABLE `TMDB_Image` DROP COLUMN `TmdbPersonID`;"),
        ...
        new(154,  2, "ALTER TABLE `TMDB_Movie` MODIFY COLUMN `Keywords` LONGTEXT NULL;"),
        new(155,  1, "RENAME TABLE `Tmdb_Show_Network` TO `TMDB_Show_Network_TMP`; RENAME TABLE `TMDB_Show_Network_TMP` TO `TMDB_Show_Network`;"),
        new(156,  1, "ALTER TABLE `CrossRef_AniDB_TMDB_Movie` ADD COLUMN `MatchRating` INT NOT NULL DEFAULT 1;"),
        new(156,  2, "UPDATE `CrossRef_AniDB_TMDB_Movie` SET `MatchRating` = 5 WHERE `Source` = 0;"),
        new(156,  3, "ALTER TABLE `CrossRef_AniDB_TMDB_Movie` DROP COLUMN `Source`;"),
        new(156,  4, "ALTER TABLE `CrossRef_AniDB_TMDB_Show` ADD COLUMN `MatchRating` INT NOT NULL DEFAULT 1;"),
        new(156,  5, "UPDATE `CrossRef_AniDB_TMDB_Show` SET `MatchRating` = 5 WHERE `Source` = 0;"),
        new(156,  6, "ALTER TABLE `CrossRef_AniDB_TMDB_Show` DROP COLUMN `Source`;"),
        ...
        new(158,  1, "CREATE TABLE `StoredReleaseInfo` (`StoredReleaseInfoID` INT NOT NULL AUTO_INCREMENT, `ED2K` VARCHAR(40) NOT NULL, `FileSize` BIGINT NOT NULL, `ID` VARCHAR(128), `ProviderName` VARCHAR(128) NOT NULL, `ReleaseURI` VARCHAR(1024), `Version` INT NOT NULL, `ProvidedFileSize` BIGINT, `Comment` VARCHAR(1024), `OriginalFilename` VARCHAR(1024), `IsCensored` INT, `IsChaptered` INT, `IsCreditless` INT, `IsCorrupted` INT NOT NULL, `Source` INT NOT NULL, `GroupID` VARCHAR(128), `GroupSource` VARCHAR(128), `GroupName` VARCHAR(128), `GroupShortName` VARCHAR(128), `Hashes` TEXT NULL, `AudioLanguages` VARCHAR(512), `SubtitleLanguages` VARCHAR(512), `CrossReferences` TEXT NOT NULL, `Metadata` TEXT NULL, `ReleasedAt` DATE, `LastUpdatedAt` DATETIME NOT NULL, `CreatedAt` DATETIME NOT NULL, PRIMARY KEY (`StoredReleaseInfoID`));"),
        new(158,  2, "CREATE TABLE `StoredReleaseInfo_MatchAttempt` (`StoredReleaseInfo_MatchAttemptID` INT NOT NULL AUTO_INCREMENT, `AttemptProviderNames` VARCHAR(1024) NOT NULL, `ProviderName` VARCHAR(128), `ProviderID` VARCHAR(40), `ED2K` VARCHAR(40) NOT NULL, `FileSize` BIGINT NOT NULL, `AttemptStartedAt` DATETIME NOT NULL, `AttemptEndedAt` DATETIME NOT NULL, PRIMARY KEY (`StoredReleaseInfo_MatchAttemptID`));"),
        new(158,  3, "CREATE TABLE `VideoLocal_HashDigest` (`VideoLocal_HashDigestID` INT NOT NULL AUTO_INCREMENT, `VideoLocalID` INT NOT NULL, `Type` VARCHAR(32) NOT NULL, `Value` TEXT NOT NULL, `Metadata` TEXT, PRIMARY KEY (`VideoLocal_HashDigestID`));"),
        new(158,  4, DatabaseFixes.MoveAnidbFileDataToReleaseInfoFormat),
        new(158,  5, "ALTER TABLE `ImportFolder` DROP COLUMN `ImportFolderType`;"),
        new(158,  6, "ALTER TABLE `VideoLocal_Place` DROP COLUMN `ImportFolderType`;"),
        new(159,  1, "CREATE TABLE `StoredRelocationPipe` (`StoredRelocationPipeID` INT NOT NULL AUTO_INCREMENT, `ProviderID` VARCHAR(40) NOT NULL, `Name` VARCHAR(128) NOT NULL, `Configuration` BLOB, PRIMARY KEY (`StoredRelocationPipeID`));"),
        new(159,  2, "CREATE INDEX IX_StoredRelocationPipe_ProviderID ON StoredRelocationPipe(ProviderID);"),
        new(159,  3, "CREATE INDEX IX_StoredRelocationPipe_Name ON StoredRelocationPipe(Name);"),
        new(159,  4, DatabaseFixes.MigrateRenamers),
        new(159,  5, "DROP TABLE IF EXISTS `CrossRef_AniDB_Trakt_Episode`;"),
        new(159,  6, "DROP TABLE IF EXISTS `AniDB_Recommendation`;"),
        new(159,  7, "UPDATE CrossRef_AniDB_TMDB_Show SET MatchRating = 0 WHERE MatchRating = 6;"),
        new(159,  8, "UPDATE CrossRef_AniDB_TMDB_Episode SET MatchRating = 0 WHERE MatchRating = 6;"),
        new(159,  9, "UPDATE CrossRef_AniDB_TMDB_Movie SET MatchRating = 0 WHERE MatchRating = 6;"),
        ...
        new(159, 13, "ALTER TABLE `AnimeSeries_User` ADD COLUMN `LastVideoUpdate` datetime;"),
        new(159, 14, "ALTER TABLE `AnimeSeries_User` ADD COLUMN `LastUpdated` datetime NOT NULL DEFAULT '0001-01-01 00:00:00';"),
        new(159, 15, "ALTER TABLE `AnimeSeries_User` ADD COLUMN `UserTags` TEXT NOT NULL DEFAULT '';"),
        new(159, 16, "ALTER TABLE `AnimeEpisode_User` ADD COLUMN `AbsoluteUserRating` INT;"),
        ...
        new(170,  1, "UPDATE `VideoLocal` SET `Hash` = UPPER(`Hash`)"),
        new(170,  2, "UPDATE `FileNameHash` SET `Hash` = UPPER(`Hash`)"),
        new(170,  3, "UPDATE `CrossRef_File_Episode` SET `Hash` = UPPER(`Hash`) WHERE `Hash` IS NOT NULL"),
        new(170,  4, "UPDATE `StoredReleaseInfo` SET `ED2K` = UPPER(`ED2K`)"),
        new(170,  5, "UPDATE `StoredReleaseInfo_MatchAttempt` SET `ED2K` = UPPER(`ED2K`)"),
        new(170,  6, "UPDATE `VideoLocal_HashDigest` SET `Type` = UPPER(`Type`)"),
        new(170,  7, "UPDATE `VideoLocal_HashDigest` SET `Value` = UPPER(`Value`) WHERE `Type` IN ('ED2K','CRC32','MD5','SHA1','SHA256','SHA512')"),
        new(170,  8, "ALTER TABLE `VideoLocal` MODIFY COLUMN `Hash` VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL"),
        new(170,  9, "ALTER TABLE `VideoLocal_Place` MODIFY COLUMN `FilePath` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL"),
        new(170, 10, "ALTER TABLE `ImportFolder` MODIFY COLUMN `ImportFolderLocation` VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL"),
        new(170, 11, "ALTER TABLE `AuthTokens` MODIFY COLUMN `Token` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin"),
        new(170, 12, "ALTER TABLE `FileNameHash` MODIFY COLUMN `Hash` VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL"),
        new(170, 13, "ALTER TABLE `FileNameHash` MODIFY COLUMN `FileName` VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL"),
        new(170, 14, "ALTER TABLE `CrossRef_File_Episode` MODIFY COLUMN `Hash` VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL"),
        new(170, 15, "ALTER TABLE `CrossRef_File_Episode` MODIFY COLUMN `FileName` VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL"),
        new(170, 16, "ALTER TABLE `StoredReleaseInfo` MODIFY COLUMN `ED2K` VARCHAR(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL"),
        new(170, 17, "ALTER TABLE `StoredReleaseInfo` MODIFY COLUMN `ReleaseURI` VARCHAR(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL"),
        new(170, 18, "ALTER TABLE `StoredReleaseInfo_MatchAttempt` MODIFY COLUMN `ED2K` VARCHAR(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL"),
        new(170, 19, "ALTER TABLE `VideoLocal_HashDigest` MODIFY COLUMN `Type` VARCHAR(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL"),
        new(170, 20, "ALTER TABLE `VideoLocal_HashDigest` MODIFY COLUMN `Value` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL"),
        new(171,  1, "ALTER TABLE `AniDB_Anime` ADD COLUMN `AirDate_new` varchar(10) NULL, ADD COLUMN `EndDate_new` varchar(10) NULL"),
        ...
        new(188,  1, "CREATE TABLE `AiringSchedule` ( `AiringScheduleID` INT NOT NULL AUTO_INCREMENT, `ProviderID` VARCHAR(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, `ProviderName` VARCHAR(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, `SeriesSource` TINYINT UNSIGNED NOT NULL, `SeriesID` VARCHAR(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, `SeasonID` VARCHAR(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, `Key` VARCHAR(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, `ChannelID` VARCHAR(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL, `Tracks` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, `FirstEpisodeNumber` INT NULL, `LastEpisodeNumber` INT NULL, `IsFinished` BIT NOT NULL, `TimeZoneID` VARCHAR(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL, `Url` VARCHAR(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL, `CreatedAt` DATETIME NOT NULL, `LastUpdatedAt` DATETIME NOT NULL, PRIMARY KEY (`AiringScheduleID`) );"),
        new(188,  2, "CREATE TABLE `EpisodeAiring` ( `EpisodeAiringID` INT NOT NULL AUTO_INCREMENT, `AiringScheduleID` INT NOT NULL, `Key` VARCHAR(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, `EpisodeSource` TINYINT UNSIGNED NOT NULL, `EpisodeID` VARCHAR(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, `Url` VARCHAR(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL, `AiredAt` DATETIME NULL, `OriginalAiredAt` DATETIME NULL, `IsDelayed` BIT NOT NULL, `LinkedToID` INT NULL, `CreatedAt` DATETIME NOT NULL, `LastUpdatedAt` DATETIME NOT NULL, PRIMARY KEY (`EpisodeAiringID`) );"),
        new(188,  3, "CREATE TABLE `AiringChannel` ( `AiringChannelID` INT NOT NULL AUTO_INCREMENT, `ChannelID` VARCHAR(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, `Name` VARCHAR(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, `NormalizedName` VARCHAR(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, `Type` TINYINT UNSIGNED NOT NULL, `Aliases` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, `CreatedAt` DATETIME NOT NULL, PRIMARY KEY (`AiringChannelID`) );"),
        new(188,  4, "CREATE UNIQUE INDEX `UIX_AiringSchedule_Provider_Series_Season_Key` ON `AiringSchedule`(`ProviderID`, `SeriesSource`, `SeriesID`, `SeasonID`, `Key`);"),
        new(188,  5, "CREATE INDEX `IX_AiringSchedule_ProviderID` ON `AiringSchedule`(`ProviderID`);"),
        new(188,  6, "CREATE INDEX `IX_AiringSchedule_SeriesSource_SeriesID` ON `AiringSchedule`(`SeriesSource`, `SeriesID`);"),
        new(188,  7, "CREATE INDEX `IX_AiringSchedule_ChannelID` ON `AiringSchedule`(`ChannelID`);"),
        new(188,  8, "CREATE UNIQUE INDEX `UIX_EpisodeAiring_AiringScheduleID_Key` ON `EpisodeAiring`(`AiringScheduleID`, `Key`);"),
        new(188,  9, "CREATE INDEX `IX_EpisodeAiring_EpisodeSource_EpisodeID` ON `EpisodeAiring`(`EpisodeSource`, `EpisodeID`);"),
        new(188, 10, "CREATE INDEX `IX_EpisodeAiring_LinkedToID` ON `EpisodeAiring`(`LinkedToID`);"),
        new(188, 11, "CREATE UNIQUE INDEX `UIX_AiringChannel_ChannelID` ON `AiringChannel`(`ChannelID`);"),
        new(188, 12, "CREATE INDEX `IX_AiringChannel_Type_NormalizedName` ON `AiringChannel`(`Type`, `NormalizedName`);"),
    ...
    #region Tables | Rename Commands

    private readonly List<DatabaseCommand> _linuxTableFixes =
    [
        new("RENAME TABLE anidb_anime TO AniDB_Anime;"),
        new("RENAME TABLE anidb_anime_category TO AniDB_Anime_Category;"),
        new("RENAME TABLE anidb_anime_character TO AniDB_Anime_Character;"),
        new("RENAME TABLE anidb_anime_defaultimage TO AniDB_Anime_DefaultImage;"),
        new("RENAME TABLE anidb_anime_relation TO AniDB_Anime_Relation;"),
        new("RENAME TABLE anidb_anime_review TO AniDB_Anime_Review;"),
        new("RENAME TABLE anidb_anime_similar TO AniDB_Anime_Similar;"),
        new("RENAME TABLE anidb_anime_tag TO AniDB_Anime_Tag;"),
        new("RENAME TABLE anidb_anime_title TO AniDB_Anime_Title;"),
        new("RENAME TABLE anidb_category TO AniDB_Category;"),
        new("RENAME TABLE anidb_character TO AniDB_Character;"),
        new("RENAME TABLE anidb_character_seiyuu TO AniDB_Character_Seiyuu;"),
        new("RENAME TABLE anidb_episode TO AniDB_Episode;"),
        new("RENAME TABLE anidb_file TO AniDB_File;"),
        new("RENAME TABLE anidb_groupstatus TO AniDB_GroupStatus;"),
        new("RENAME TABLE anidb_myliststats TO AniDB_MylistStats;"),
        new("RENAME TABLE anidb_recommendation TO AniDB_Recommendation;"),
        new("RENAME TABLE anidb_releasegroup TO AniDB_ReleaseGroup;"),
        new("RENAME TABLE anidb_review TO AniDB_Review;"),
        new("RENAME TABLE anidb_seiyuu TO AniDB_Seiyuu;"),
        new("RENAME TABLE anidb_tag TO AniDB_Tag;"),
        new("RENAME TABLE anidb_vote TO AniDB_Vote;"),
        new("RENAME TABLE animeepisode TO AnimeEpisode;"),
        new("RENAME TABLE animeepisode_user TO AnimeEpisode_User;"),
        new("RENAME TABLE animegroup TO AnimeGroup;"),
        new("RENAME TABLE animegroup_user TO AnimeGroup_User;"),
        new("RENAME TABLE animeseries TO AnimeSeries;"),
        new("RENAME TABLE animeseries_user TO AnimeSeries_User;"),
        new("RENAME TABLE bookmarkedanime TO BookmarkedAnime;"),
        new("RENAME TABLE commandrequest TO CommandRequest;"),
        new("RENAME TABLE crossref_anidb_mal TO CrossRef_AniDB_MAL;"),
        new("RENAME TABLE crossref_anidb_other TO CrossRef_AniDB_Other;"),
        new("RENAME TABLE crossref_anidb_trakt TO CrossRef_AniDB_Trakt;"),
        new("RENAME TABLE crossref_anidb_trakt_episode TO CrossRef_AniDB_Trakt_Episode;"),
        new("RENAME TABLE crossref_anidb_traktv2 TO CrossRef_AniDB_TraktV2;"),
        new("RENAME TABLE crossref_anidb_tvdb TO CrossRef_AniDB_TvDB;"),
        new("RENAME TABLE crossref_anidb_tvdb_episode TO CrossRef_AniDB_TvDB_Episode;"),
        new("RENAME TABLE crossref_anidb_tvdbv2 TO CrossRef_AniDB_TvDBV2;"),
        new("RENAME TABLE crossref_customtag TO CrossRef_CustomTag;"),
        new("RENAME TABLE crossref_file_episode TO CrossRef_File_Episode;"),
        new("RENAME TABLE crossref_languages_anidb_file TO CrossRef_Languages_AniDB_File;"),
        new("RENAME TABLE crossref_subtitles_anidb_file TO CrossRef_Subtitles_AniDB_File;"),
        new("RENAME TABLE customtag TO CustomTag;"),
        new("RENAME TABLE duplicatefile TO DuplicateFile;"),
        new("RENAME TABLE fileffdshowpreset TO FileFfdshowPreset;"),
        new("RENAME TABLE filenamehash TO FileNameHash;"),
        new("RENAME TABLE groupfilter TO GroupFilter;"),
        new("RENAME TABLE groupfiltercondition TO GroupFilterCondition;"),
        new("RENAME TABLE ignoreanime TO IgnoreAnime;"),
        new("RENAME TABLE importfolder TO ImportFolder;"),
        new("RENAME TABLE jmmuser TO JMMUser;"),
        new("RENAME TABLE language TO Language;"),
        new("RENAME TABLE logmessage TO LogMessage;"),
        new("RENAME TABLE moviedb_fanart TO MovieDB_Fanart;"),
        new("RENAME TABLE moviedb_movie TO MovieDB_Movie;"),
        new("RENAME TABLE moviedb_poster TO MovieDB_Poster;"),
        new("RENAME TABLE playlist TO Playlist;"),
        new("RENAME TABLE renamescript TO RenameScript;"),
        new("RENAME TABLE scheduledupdate TO ScheduledUpdate;"),
        new("RENAME TABLE trakt_episode TO Trakt_Episode;"),
        new("RENAME TABLE trakt_friend TO Trakt_Friend;"),
        new("RENAME TABLE trakt_imagefanart TO Trakt_ImageFanart;"),
        new("RENAME TABLE trakt_imageposter TO Trakt_ImagePoster;"),
        new("RENAME TABLE trakt_season TO Trakt_Season;"),
        new("RENAME TABLE trakt_show TO Trakt_Show;"),
        new("RENAME TABLE tvdb_episode TO TvDB_Episode;"),
        new("RENAME TABLE tvdb_imagefanart TO TvDB_ImageFanart;"),
        new("RENAME TABLE tvdb_imageposter TO TvDB_ImagePoster;"),
        new("RENAME TABLE tvdb_imagewidebanner TO TvDB_ImageWideBanner;"),
        new("RENAME TABLE tvdb_series TO TvDB_Series;"),
        new("RENAME TABLE videoinfo TO VideoInfo;"),
        new("RENAME TABLE videolocal TO VideoLocal;"),
        new("RENAME TABLE videolocal_user TO VideoLocal_User;")
    ];

    #endregion

    #region Tables | MySQL Helpers

    private static void DropMALIndex()
    {
    ...
    private static void DropAniDBUniqueIndex()
    {
        using MySqlConnection conn = new(ConnectionString);
        conn.Open();
        var query =
        ...
        if (rows.Count > 0)
        {
            foreach (var row in rows)
            {
                var alter = row[3].ToString()!.ToLowerInvariant() switch
                {
                    ...
                    "mediumtext" or
                    "tinytext" or
                    "longtext" => $"ALTER TABLE `{row[1]}` MODIFY `{row[2]}` {row[3]} CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci'",
                    _ => $"ALTER TABLE `{row[1]}` MODIFY `{row[2]}` {row[3]}({row[4]}) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci'",
                };
