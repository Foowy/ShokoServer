...
public static class LanguageExtensions
{
    ...
    // ConcurrentDictionary used as a thread-safe set; concurrent callers otherwise corrupt a plain HashSet.
    ...
    /// <remarks>This method may be paired with <see cref="GetTitleLanguage(string)"/> for conversion.<br/>
